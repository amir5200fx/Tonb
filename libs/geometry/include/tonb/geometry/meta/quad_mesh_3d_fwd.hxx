...
//
#pragma once
#ifndef TONB_GEOMETRY_META_QUAD_MESH_3D_FWD_HXX
#define TONB_GEOMETRY_META_QUAD_MESH_3D_FWD_HXX
#include <tonb/base/index_types.hxx>
#include <cstdint>
/**
 * @file
 * @brief Forward declarations for 3D quad mesh types
 *
 * This header declares the minimal types required to reference a 3D quad mesh
 ...
 *  (`GeometrySet<Pnt3d, Connectivity<4, void>>`).
 *
...
namespace tonb::geometry {
    ...
    namespace meta {
        ...
        using QuadMesh3d = GeometrySet<Pnt3d, Connectivity<4, void>>;
    }
}
#endif //TONB_GEOMETRY_META_QUAD_MESH_3D_FWD_HXX