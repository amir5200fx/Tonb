#pragma once
#ifndef _AirfoilPx_PxCamberProfile_t1_Header
#define _AirfoilPx_PxCamberProfile_t1_Header
...
namespace tnbLib
{
	...
	namespace profileLib
	{
		...
		class CamberProfile_t1
			: public AirfoilPx_PxCamberProfile
		{
		...
		public:
			...
			TnbAirfoil_EXPORT std::pair<Standard_Real, Dir2d> 
				Value(const Standard_Real) const override;
...
BOOST_CLASS_EXPORT_KEY(tnbLib::profileLib::CamberProfile_t1);

#endif // !_AirfoilPx_PxCamberProfile_t1_Header
