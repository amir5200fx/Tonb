...
void tnbLib::calculateProperties_pT
(
	scalar &p,
	scalar &T,
	scalar &h,
...
void tnbLib::calculateProperties_h
(
	SteamState S,
	scalar &p,
	scalar &h,
...
tnbLib::scalar tnbLib::rho_pT(scalar p, scalar T)
{
...
tnbLib::scalar tnbLib::rho_ph(scalar p, scalar h)
{
...
tnbLib::scalar tnbLib::cp_pT(scalar p, scalar T)
{
...
tnbLib::scalar tnbLib::cv_ph(scalar p, scalar h)
{
...
tnbLib::scalar tnbLib::h_pT(scalar p, scalar T)
{
...
tnbLib::scalar tnbLib::T_ph(scalar p, scalar h)
{
...
tnbLib::scalar tnbLib::psiH_pT(scalar p, scalar T)
{
...
//CL: psiH=(drho/dp)_h=const
tnbLib::scalar tnbLib::psiH_ph(scalar p, scalar h)
{
...
//CL: psiH=(drho/dp)_h=const
tnbLib::scalar tnbLib::psiH(SteamState S)
{
	label region;
...
//CL: drhodh=(drho/dh)_p=const
tnbLib::scalar tnbLib::drhodh_pT(scalar p, scalar T)
{
...
//CL: drhodh=(drho/dh)_p=const
tnbLib::scalar tnbLib::drhodh_ph(scalar p, scalar h)
{
...
//CL: drhodh=(drho/dh)_p=const
tnbLib::scalar tnbLib::drhodh(SteamState S)
{
	label region;
