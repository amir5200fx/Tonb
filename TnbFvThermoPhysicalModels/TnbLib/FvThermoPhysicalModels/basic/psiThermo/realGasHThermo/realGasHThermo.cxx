...
void tnbLib::realGasHThermo<MixtureType>::calculate()
{
...
template<class MixtureType>
tnbLib::realGasHThermo<MixtureType>::realGasHThermo
(
	const fvMesh& mesh,
...
template<class MixtureType>
void tnbLib::realGasHThermo<MixtureType>::correct()
{
	if (debug)
	{
...
template<class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::realGasHThermo<MixtureType>::h
(
	const scalarField& T,
...
template<class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::realGasHThermo<MixtureType>::rho
(
	const scalarField& T,
	const label patchi
) const
...
template<class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::realGasHThermo<MixtureType>::Cp
(
	const scalarField& T,
	const label patchi
) const
...
template<class MixtureType>
tnbLib::tmp<tnbLib::volScalarField> tnbLib::realGasHThermo<MixtureType>::Cp() const
{
...
template<class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::realGasHThermo<MixtureType>::Cv
(
	const scalarField& T,
	const label patchi
) const
...
template<class MixtureType>
tnbLib::tmp<tnbLib::volScalarField> tnbLib::realGasHThermo<MixtureType>::rho()  const
{
...
template<class MixtureType>
tnbLib::tmp<tnbLib::volScalarField> tnbLib::realGasHThermo<MixtureType>::Cv() const
{
	const fvMesh& mesh = this->T_.mesh();
...
template<class MixtureType>
bool tnbLib::realGasHThermo<MixtureType>::read()
{
