#pragma once
#ifndef _ShapePx_TopoSect_Slider_Header
#define _ShapePx_TopoSect_Slider_Header
...
namespace tnbLib
{
	...
	namespace shapePxLib
	{
		...
		public:
			...
			TopoSect_Slider(const Standard_Integer theIndex, const word& theName)
...
BOOST_CLASS_EXPORT_KEY(tnbLib::shapePxLib::TopoSect_Slider);

#endif // !_ShapePx_TopoSect_Slider_Header
