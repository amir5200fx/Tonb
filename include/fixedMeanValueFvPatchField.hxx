#pragma once
#ifndef _fixedMeanValueFvPatchField_Header
#define _fixedMeanValueFvPatchField_Header
...
namespace tnbLib
{
	...
	/*---------------------------------------------------------------------------*\
				   Class fixedMeanValueFvPatchField Declaration
	\*---------------------------------------------------------------------------*/
...
#ifdef NoRepository
#   include <fixedMeanValueFvPatchField.cxx>
#endif

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

#endif // !_fixedMeanValueFvPatchField_Header
