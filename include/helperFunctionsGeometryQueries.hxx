#pragma once
#ifndef _helperFunctionsGeometryQueries_Header
#define _helperFunctionsGeometryQueries_Header
...
namespace tnbLib
{
	...
	namespace help
	{
		...
		(
			...
			const scalar cosTol = tnbLib::cos(5.0*(M_PI / 180.0)) // cosine tolerance
		);
...
#include <helperFunctionsGeometryQueriesI.hxx>

#endif // !_helperFunctionsGeometryQueries_Header
