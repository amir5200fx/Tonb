#pragma once
#ifndef _Discret2d_Curve_Header
#define _Discret2d_Curve_Header
...
namespace tnbLib
{
	...
	private:
		...
		std::shared_ptr<Cad_ParaCurve> theCurve_;

		std::shared_ptr<Discret2d_Curve_Function> theFun_;
	...
	public:
		...
		void SetCurve(const std::shared_ptr<Cad_ParaCurve>& theCurve)
		{
			theCurve_ = theCurve;
		}

		void SetFunction(const std::shared_ptr<Discret2d_Curve_Function>& theFun)
		{
			theFun_ = theFun;
		}
