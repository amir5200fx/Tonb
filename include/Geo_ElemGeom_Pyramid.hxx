#pragma once
#ifndef _Geo_ElemGeom_Pyramid_Header
#define _Geo_ElemGeom_Pyramid_Header
...
namespace tnbLib
{
	...
	public:
		...
		Geo_ElemGeom_Pyramid(const std::array<Standard_Integer, nbNodes>& theIndices)
			: theIndices_(theIndices)
		{}

		Geo_ElemGeom_Pyramid(std::array<Standard_Integer, nbNodes>&& theIndices)
...
BOOST_CLASS_EXPORT_KEY(tnbLib::Geo_ElemGeom_Pyramid);

#endif // !_Geo_ElemGeom_Pyramid_Header
