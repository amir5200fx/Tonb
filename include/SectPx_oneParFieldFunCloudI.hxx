...
namespace tnbLib
{
	...
	std::shared_ptr<FieldFun> 
		SectPx_oneParFieldFunCloud::Maker
		(
		...
		)
	{
		...
		Debug_Null_Pointer(SELECT_PARCLOUD_FROM_REGISTRY(theReg, theParId));
		field->SetPar(SELECT_PARCLOUD_FROM_REGISTRY(theReg, theParId));
