...
namespace tnbLib
{
	namespace marineLib
	{
		...
		template<>
		template<>
		TnbMarine_EXPORT void BodyConstructor_Shape<Body_Displacer>::serialize<TNB_iARCH_TYPE>
			(
				TNB_iARCH_TYPE& ar,
		...
		template<>
		template<>
		TnbMarine_EXPORT void BodyConstructor_Shape<Body_Displacer>::serialize<TNB_oARCH_TYPE>
			(
				TNB_oARCH_TYPE& ar, 
				const unsigned int file_vertion
				);
