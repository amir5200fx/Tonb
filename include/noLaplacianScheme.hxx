#pragma once
#ifndef _noLaplacianScheme_Header
#define _noLaplacianScheme_Header
...
namespace tnbLib
{
	...
	namespace fv
	{
		...
		/*---------------------------------------------------------------------------*\
							   Class noLaplacianScheme Declaration
		\*---------------------------------------------------------------------------*/
...
#ifdef NoRepository
#   include <noLaplacianScheme.cxx>
#endif

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

#endif // !_noLaplacianScheme_Header
