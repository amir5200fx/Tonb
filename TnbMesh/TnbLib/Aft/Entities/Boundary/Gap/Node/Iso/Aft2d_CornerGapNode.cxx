...
template<>
std::shared_ptr<tnbLib::Aft2d_BndEdge>
tnbLib::Aft2d_CornerGapNode::BlowThisUp()
{
	...
	std::shared_ptr<Aft2d_BndEdge> gapEdge;
	std::shared_ptr<Aft2d_BndEdge> nonGapEdge;
	{
	...
	std::shared_ptr<Aft2d_BndNode> n0;
	std::shared_ptr<Aft2d_BndNode> n1;
	{// retrieve the node n0 and an1 [5/13/2022 Amir]
		if (gapEdge->Node0()->Index() IS_EQUAL thisId)
		{
			n1 = std::dynamic_pointer_cast<Aft2d_BndNode>(gapEdge->Node1());
		...
		{
			n0 = std::dynamic_pointer_cast<Aft2d_BndNode>(gapEdge->Node0());
	...
	{// retrieve the node n0 and an1 [5/13/2022 Amir]
		...
		{
			n1 = std::dynamic_pointer_cast<Aft2d_BndNode>(nonGapEdge->Node1());
			Debug_Null_Pointer(n1);
		...
		{
			n0 = std::dynamic_pointer_cast<Aft2d_BndNode>(nonGapEdge->Node0());
			Debug_Null_Pointer(n0);
