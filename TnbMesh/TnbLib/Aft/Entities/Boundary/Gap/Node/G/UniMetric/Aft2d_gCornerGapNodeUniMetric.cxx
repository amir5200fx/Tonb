...
template<>
void tnbLib::Aft2d_gCornerGapNodeUniMetric::BlowThisUp(const Geo2d_MetricPrcsrUniMetric& thePrcsr)
{
	...
	std::shared_ptr<Aft2d_BndEdgeSurface> gapEdge;
	std::shared_ptr<Aft2d_BndEdgeSurface> nonGapEdge;
	{
	...
	{// retrieve the node n0 and an1 [5/13/2022 Amir]
		...
		{
			n1 = std::dynamic_pointer_cast<Aft2d_BndNodeSurface>(gapEdge->Node1());
		...
		{
			n0 = std::dynamic_pointer_cast<Aft2d_BndNodeSurface>(gapEdge->Node0());
	...
	{// retrieve the node n0 and an1 [5/13/2022 Amir]
		...
		{
			n1 = std::dynamic_pointer_cast<Aft2d_BndNodeSurface>(nonGapEdge->Node1());
			Debug_Null_Pointer(n1);
		...
		{
			n0 = std::dynamic_pointer_cast<Aft2d_BndNodeSurface>(nonGapEdge->Node0());
			Debug_Null_Pointer(n0);
