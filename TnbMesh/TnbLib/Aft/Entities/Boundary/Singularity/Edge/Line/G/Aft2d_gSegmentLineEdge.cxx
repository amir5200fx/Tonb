#include <Aft2d_gSegmentLineEdge.hxx>
...
template<>
Standard_Boolean tnbLib::Aft2d_gSegmentLineEdge::SingularityContraction(const Geo2d_MetricPrcsrAnIso& thePrcsr)
{
...
tnbLib::Aft2d_gSegmentLineEdge::GetTopology
(
...
)
{
	...
	K++;
	auto n0 = std::make_shared<Aft2d_gCornerLineNode>(K, pts[K - 1]);
	nodes.push_back(n0);
	...
	{
		K++;
		auto n = std::make_shared<Aft2d_gSegmentLineNode>(K, pts[K - 1]);
	...
	K++;
	auto n1 = std::make_shared<Aft2d_gCornerLineNode>(K, pts[K - 1]);
	nodes.push_back(n1);
	...
	for (size_t i = 1; i < nodes.size(); i++)
	{
		...
		auto edge = std::make_shared<Aft2d_gSegmentLineEdge>(++K, n0, n1);
