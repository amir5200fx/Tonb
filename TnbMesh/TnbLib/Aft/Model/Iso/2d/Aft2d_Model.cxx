...
namespace tnbLib
{
	...
	(
		const Aft2d_Edge& theFront,
		const Aft2d_Node& theNode,
		const Aft2d_MetricPrcsr& theMetric,
...
template<>
void tnbLib::Aft2d_Model::FindValidNode
(
	const std::vector<std::shared_ptr<Aft2d_Node>>& theCandidates,
	const std::vector<std::shared_ptr<Aft2d_Edge>>& theEffectives
)
{
...
template<>
void tnbLib::Aft2d_Model::InsertNewFrontsToLevels()
{
#ifdef AFT_MODEL_DEBUG
...
template<>
void tnbLib::Aft2d_Model::CompactNumbering
(
...
template<>
void tnbLib::Aft2d_Model::ActiveFront
(
...
template<>
void tnbLib::Aft2d_Model::CheckBoundary
(
	const std::vector<std::shared_ptr<Aft2d_Edge>>& theFronts
)
{
