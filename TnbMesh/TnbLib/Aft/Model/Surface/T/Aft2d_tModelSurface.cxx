...
template<>
void tnbLib::Aft2d_tModelSurface::Import
(
...
#ifdef AFT_MODEL_DEBUG
template<>
void tnbLib::Aft2d_tModelSurface::MeshingOneLevel()
{
	if (verbose)
	{
...
template<>
void tnbLib::Aft2d_tModelSurface::FindValidNode
(
...
template<>
void tnbLib::Aft2d_tModelSurface::InsertNewFrontsToLevels()
{
#ifdef AFT_MODEL_DEBUG
...
template<>
void tnbLib::Aft2d_tModelSurface::CompactNumbering
(
...
template<>
void tnbLib::Aft2d_tModelSurface::ActiveFront
(
...
template<>
void tnbLib::Aft2d_tModelSurface::CheckBoundary
(
	const std::vector<std::shared_ptr<Aft2d_EdgeSurface>>& theFronts
)
{
