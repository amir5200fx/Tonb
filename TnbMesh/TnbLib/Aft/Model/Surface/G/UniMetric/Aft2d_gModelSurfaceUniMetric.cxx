...
unsigned short tnbLib::Aft2d_gModelSurfaceUniMetric::verbose(0);

template<>
void tnbLib::Aft2d_gModelSurfaceUniMetric::Import
(
...
#ifdef AFT_MODEL_DEBUG
template<>
void tnbLib::Aft2d_gModelSurfaceUniMetric::MeshingOneLevel()
{
	if (verbose)
	{
...
template<>
void tnbLib::Aft2d_gModelSurfaceUniMetric::FindValidNode
(
...
template<>
void tnbLib::Aft2d_gModelSurfaceUniMetric::InsertNewFrontsToLevels()
{
#ifdef AFT_MODEL_DEBUG
...
template<>
void tnbLib::Aft2d_gModelSurfaceUniMetric::CompactNumbering
(
...
template<>
void tnbLib::Aft2d_gModelSurfaceUniMetric::CheckSelfIntersection()
{
...
template<>
void tnbLib::Aft2d_gModelSurfaceUniMetric::ActiveFront
(
...
template<>
void tnbLib::Aft2d_gModelSurfaceUniMetric::CheckBoundary
(
	const std::vector<std::shared_ptr<Aft2d_EdgeSurface>>& theFronts
)
{
