...
namespace tnbLib
{
	...
	template<>
	template<>
	TnbMesh_EXPORT void Aft2d_OptNodeAnIso_Calculator::serialize<TNB_iARCH_TYPE>
		(
			TNB_iARCH_TYPE& ar,
	...
	template<>
	template<>
	TnbMesh_EXPORT void Aft2d_OptNodeAnIso_Calculator::serialize<TNB_oARCH_TYPE>
		(
			TNB_oARCH_TYPE& ar,
			const unsigned int /*file_version*/
			);
...
BOOST_SERIALIZATION_ASSUME_ABSTRACT(tnbLib::Aft2d_OptNodeAnIso_Calculator);
