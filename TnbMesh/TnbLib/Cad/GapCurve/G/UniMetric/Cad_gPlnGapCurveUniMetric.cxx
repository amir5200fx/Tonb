...
std::pair
<
	std::shared_ptr<tnbLib::Aft2d_gPlnCurveSurfaceUniMetric>,
	std::shared_ptr<tnbLib::Aft2d_gPlnCurveSurfaceUniMetric>
>
tnbLib::Cad_gPlnGapCurveUniMetric::Split(const Standard_Real x) const
{
	...
	auto C0 = std::make_shared<Cad_gPlnGapCurveUniMetric>(std::move(c0));
	auto C1 = std::make_shared<Cad_gPlnGapCurveUniMetric>(std::move(c1));
...
tnbLib::Cad_gPlnGapCurveUniMetric::TopoMesh<tnbLib::Aft2d_gSegmentEdgeUniMetric>
(
	...
	)
{
	...
	auto edges = Aft2d_gSegmentGapEdgeUniMetric::GetTopology(*poly, theCurve);
