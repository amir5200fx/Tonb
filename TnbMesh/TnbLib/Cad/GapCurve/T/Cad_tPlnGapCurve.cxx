...
) const
{
	...
	auto C0 = std::make_shared<Cad_tPlnGapCurve>(std::move(c0));
	auto C1 = std::make_shared<Cad_tPlnGapCurve>(std::move(c1));
...
tnbLib::Cad_tPlnGapCurve::TopoMesh<tnbLib::Aft2d_tSegmentEdge>
(
	...
	)
{
	...
	auto edges = Aft2d_tSegmentGapEdge::GetTopology(*poly, theCurve);
