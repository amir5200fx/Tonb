...
std::pair
<
	std::shared_ptr<tnbLib::Aft2d_tPlnCurveSurfaceUniMetric>,
	std::shared_ptr<tnbLib::Aft2d_tPlnCurveSurfaceUniMetric>
>
tnbLib::Cad_tPlnGapCurveUniMetric::Split(const Standard_Real x) const
{
	...
	auto C0 = std::make_shared<Cad_tPlnGapCurveUniMetric>(std::move(c0));
	auto C1 = std::make_shared<Cad_tPlnGapCurveUniMetric>(std::move(c1));
...
tnbLib::Cad_tPlnGapCurveUniMetric::TopoMesh<tnbLib::Aft2d_tSegmentEdgeUniMetric>
(
	...
	)
{
	...
	auto edges = Aft2d_tSegmentGapEdgeUniMetric::GetTopology(*poly, theCurve);
