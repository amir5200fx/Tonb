...
template<>
Standard_Real 
tnbLib::Cad_gLineSingularCurve::ProjectAt
(
	const Pnt3d& thePnt,
	const GModel_Surface& thePatch
) const
{
	if (NOT Paired3d())
	{
	...
	SurfProjector.Init(pp1, GModel_Tools::RetrieveGeometry(thePatch), umin, umax, vmin, vmax);
...
tnbLib::Cad_gLineSingularCurve::TopoMesh<tnbLib::Aft2d_gSegmentEdge>
(
	...
	)
{
	...
	auto edges = Aft2d_gSegmentLineEdge::GetTopology(*poly, theCurve);
