...
namespace tnbLib
{
	word ptdModel::WingFormNo1_Chord::ROOT_CHORD = "RootChord";

	word ptdModel::WingFormNo1_Chord::TypeName_ = "Chord";
}

void tnbLib::ptdModel::WingFormNo1_Chord::Init()
{
	theParameter_ = ROOT_CHORD;
}

Standard_Integer
tnbLib::ptdModel::WingFormNo1_Chord::NbParameters() const
{
	return 1;
}

tnbLib::word
tnbLib::ptdModel::WingFormNo1_Chord::GetTypeName() const
{
	return TypeName_;
}

tnbLib::word
tnbLib::ptdModel::WingFormNo1_Chord::Parameter(const Standard_Integer /*theIndex*/) const
{
	return theParameter_;
}

std::shared_ptr<tnbLib::PtdModel_Form>
tnbLib::ptdModel::WingFormNo1_Chord::CreateForm() const
{
...
tnbLib::ptdModel::WingFormNo1_Chord::CreateProfile
(
...
) const
{
	...
	Pnt2d p0(0, GetParameter(Parameters::rootChord));
	Pnt2d p1(global->SpanLength()->Value(), GetParameter(Parameters::rootChord));
