#include <PtdModel_WingFormNo1_Thickness.hxx>
...
namespace tnbLib
{
	word ptdModel::WingFormNo1_Thickness::ROOT_THICK = "RootThick";

	word ptdModel::WingFormNo1_Thickness::TypeName_ = "Thick";
}

void tnbLib::ptdModel::WingFormNo1_Thickness::Init()
{
	theParameter_ = ROOT_THICK;
}

Standard_Integer
tnbLib::ptdModel::WingFormNo1_Thickness::NbParameters() const
{
	return 1;
}

tnbLib::word
tnbLib::ptdModel::WingFormNo1_Thickness::GetTypeName() const
{
	return TypeName_;
}

tnbLib::word
tnbLib::ptdModel::WingFormNo1_Thickness::Parameter(const Standard_Integer /*theIndex*/) const
{
	return theParameter_;
}

std::shared_ptr<tnbLib::PtdModel_Form>
tnbLib::ptdModel::WingFormNo1_Thickness::CreateForm() const
{
...
tnbLib::ptdModel::WingFormNo1_Thickness::CreateProfile
(
...
) const
{
	...
	Pnt2d p0(0, GetParameter(Parameters::rootThick));
	Pnt2d p1(global->SpanLength()->Value(), GetParameter(Parameters::rootThick));
