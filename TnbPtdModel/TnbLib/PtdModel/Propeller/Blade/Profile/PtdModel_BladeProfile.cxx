...
tnbLib::PtdModel_BladeProfile::PtdModel_BladeProfile
(
...
tnbLib::PtdModel_BladeProfile::RetrieveValues
(
...
tnbLib::PtdModel_BladeProfile::MakeProfile
(
...
)
{
	try
	{
		...
		auto profile = std::make_shared<PtdModel_BladeProfile>(std::move(c));
