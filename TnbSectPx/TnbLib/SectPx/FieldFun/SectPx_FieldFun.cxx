...
{
	auto sum = std::make_shared<binaryOpsFieldFun::Sum>();
...
{
	auto sum = std::make_shared<binaryOpsFieldFun::Subtract>();
	Debug_Null_Pointer(sum);
...
{
	auto sum = std::make_shared<binaryOpsFieldFun::Cross>();
	Debug_Null_Pointer(sum);
...
{
	auto sum = std::make_shared<binaryOpsFieldFun::Divide>();
	Debug_Null_Pointer(sum);
