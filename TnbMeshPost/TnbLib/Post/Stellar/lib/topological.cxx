                ...
                int coplanaredges[][2])
{
    ...
    *numcoplanar = 0;
    ...
    facepoints[0] = ((vertex *) tetcomplextag2vertex(mesh, vtx1))->coord;
    facepoints[1] = ((vertex *) tetcomplextag2vertex(mesh, vtx2))->coord;
    facepoints[2] = ((vertex *) tetcomplextag2vertex(mesh, vtx3))->coord;
    
    apexpoints[0] = ((vertex *) tetcomplextag2vertex(mesh, adjacencies[0]))->coord;
    apexpoints[1] = ((vertex *) tetcomplextag2vertex(mesh, adjacencies[1]))->coord;
    ...
    */
    ...
    if (edgecase == SEGMENTSEGMENTEDGE || edgecase == SEGMENTFIXEDEDGE)
    {
        if (v1type == SEGMENTVERTEX)
        {
            ...
            segment = ((vertextype *) arraypoollookup(&vertexinfo, v1))->vec;
        }
        else
        {
            assert(v2type == SEGMENTVERTEX);
            /* fetch the pre-computed vertex segment vector */
            segment = ((vertextype *) arraypoollookup(&vertexinfo, v2))->vec;
        }
        /* compute the normalized edge vector between the two vertices */
        v1c = ((vertex *) tetcomplextag2vertex(mesh, v1))->coord;
        v2c = ((vertex *) tetcomplextag2vertex(mesh, v2))->coord;
                ...
                if (outstack != NULL)
                {
                    ...
                    for (m=0; m<numouttets; m++)
                    {
                        ...
                        if (tetinstack(outstack,
                                       ...
                                       outtets[m][3]) == false)
                        {
                            stacktet = (improvetet *) stackpush(outstack);
                          ...
                          starreal *minafterqual)
{
    ...
    improvetet *stacktet;  /* for pushing newly created tets on the stack */
    bool foundface;
    tag nextprev[2];
    int ringsize;
    ...
    for (i=0; i<numboundedges; i++)
    {
        ...
        vc1 = ((vertex *) tetcomplextag2vertex(mesh, v1))->coord;
        vc2 = ((vertex *) tetcomplextag2vertex(mesh, v2))->coord;
        vc3 = ((vertex *) tetcomplextag2vertex(mesh, v3))->coord;
        vc4 = ((vertex *) tetcomplextag2vertex(mesh, v4))->coord;
        ...
        */
        ...
        if (edgeremoved == 1)
        {
            ...
            for (j=0; j<newtetcount; j++)
            {
                ...
                {
                    /* push this tet on the output stack */
                    stacktet = (improvetet *) stackpush(tetstack);
                    stacktet->quality = newqual;
                  ...
                  int *g)
{
    ...
    *qnew = quw;
    ...
    avtx = ((vertex *) tetcomplextag2vertex(mesh, a))->coord;
    bvtx = ((vertex *) tetcomplextag2vertex(mesh, b))->coord;
    uvtx = ((vertex *) tetcomplextag2vertex(mesh, u))->coord;
    vvtx = ((vertex *) tetcomplextag2vertex(mesh, v))->coord;
    wvtx = ((vertex *) tetcomplextag2vertex(mesh, w))->coord;
...
bool removemultiface(tetcomplex *mesh,
                     ...
                     int *numnewtets)
{
	facechildren facetree[MAXFACETREESIZE]; /* holds tree of faces to be removed */
    int treesize = 0;
    tag a, b;
    tag abovebelow[2];
    int foundface;
    ...
    *numnewtets = 0;
    ...
    vtxa = ((vertex *) tetcomplextag2vertex(mesh, a))->coord;
    vtxb = ((vertex *) tetcomplextag2vertex(mesh, b))->coord;
    vtxu = ((vertex *) tetcomplextag2vertex(mesh, u))->coord;
    vtxv = ((vertex *) tetcomplextag2vertex(mesh, v))->coord;
    vtxw = ((vertex *) tetcomplextag2vertex(mesh, w))->coord;
    ...
    /* now look in the tree */
    {
        for (i=0; i<treesize; i++)
        {
            vtx1 = ((vertex *) tetcomplextag2vertex(mesh, facetree[i].face[0]))->coord;
            vtx2 = ((vertex *) tetcomplextag2vertex(mesh, facetree[i].face[1]))->coord;
            vtx3 = ((vertex *) tetcomplextag2vertex(mesh, facetree[i].face[2]))->coord;
              ...
              bool quiet)
{
    ...
    improvetet *outtet;     /* point to stack tet */
    ...
    int beforeid = lastjournalentry();
    arraypoolstack savestack;     /* save the input stack in case of failure */
    ...
    *minqualafter = HUGEFLOAT;
    ...
    if (outstack != NULL)
    {
        ...
        stackinit(&savestack, sizeof(improvetet));
        ...
        improvebehave.multifaceremoval == 0)
    {
        ...
        *minqualafter = minqualbefore;
        if (outstack != NULL)
        {
            ...
            memcpy(outstack, &savestack, sizeof(arraypoolstack));
    ...
    while (tetstack->top != STACKEMPTY)
    {
        ...
        if (removed == 0 && flipped == 0 && outstack != NULL)
        {
            ...
            {
                outtet = (improvetet *) stackpush(outstack);
