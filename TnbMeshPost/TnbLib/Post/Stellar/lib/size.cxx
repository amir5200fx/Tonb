                     ...
                     bool anisotropic)
{
	...
	arraypoolstack edgestack;
	improvetet *edgetet;
    stackinit(&edgestack, sizeof(improvetet));
    ...
    while (tet[0] != STOP) 
    {
        ...
        for (i = 0; i < 6; i++) 
        {
            ...
            if (writeflag) 
            {
                ...
                edgetet = (improvetet *) stackpush(&edgestack);
    ...
    *meanedge /= numedges;
    ...
    /* compute median */
    sortstack(&edgestack);
    *medianedge = ((improvetet *) arraypoolfastlookup(&(edgestack.pool), (unsigned long) (edgestack.top + 1) / 2))->quality;
                  ...
                  arraypoolstack *tetstack)
{
    ...
    stackinit(&outstack, sizeof(improvetet));
                ...
                char **argv)
{
    ...
    int numiters = 0;
    arraypoolstack longstack;    /* stack of tets with edges too long */
    arraypoolstack shortstack;   /* stack of tets with edges too short */
    arraypoolstack meshstack;    /* stack of all mesh tets */
    int totaltets = 0;
    starreal percentbad;
    starreal worstqual;
    starreal physworst;
    ...
    stackinit(&longstack, sizeof(improvetet));
    stackinit(&shortstack, sizeof(improvetet));
    stackinit(&meshstack, sizeof(improvetet));
