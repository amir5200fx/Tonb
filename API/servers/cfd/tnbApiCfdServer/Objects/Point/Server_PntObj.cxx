...
const std::string tnbLib::Server_PntObj::Params::x = "x";
const std::string tnbLib::Server_PntObj::Params::y = "y";

void tnbLib::Server_PntObj::Construct(const std::string& theValue)
{
