...
/* VRes = Q * V */
{
	...
	size_t *QLen;
	bool MultiplDVIsZero, MultiplUVIsZero, MultiplLVIsZero;
	bool MultiplDVIsOne, MultiplUVIsOne, MultiplLVIsOne;
	bool MultiplDULVEquals;
...
matrices */
{
	...
	size_t *QLen;
	bool MultiplDIsZero, MultiplUIsZero, MultiplLIsZero;
	bool MultiplDIsOne, MultiplUIsOne, MultiplLIsOne, MultiplVIsOne,
		MultiplDVIsOne;
	ElType **QEl, *PtrEl;
	Real *QInvDiagEl;
	Real *VCmp, *VResCmp;
