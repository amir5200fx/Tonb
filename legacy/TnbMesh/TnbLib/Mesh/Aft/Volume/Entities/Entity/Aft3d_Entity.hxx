#pragma once
#ifndef _Aft3d_Entity_Header
#define _Aft3d_Entity_Header
...
namespace tnbLib
{
	...
	namespace legLib
	{
		...
		protected:
			...
			Aft3d_Entity(const Standard_Integer theIndex)
...
BOOST_SERIALIZATION_ASSUME_ABSTRACT(tnbLib::legLib::Aft3d_Entity);

#endif // !_Aft3d_Entity_Header
