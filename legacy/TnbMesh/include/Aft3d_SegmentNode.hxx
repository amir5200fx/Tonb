#pragma once
#ifndef _Aft3d_SegmentNode_Header
#define _Aft3d_SegmentNode_Header
...
namespace tnbLib
{
	...
	namespace legLib
	{
		...
		public:
			...
			explicit Aft3d_SegmentNode(const Standard_Integer theIndex)
...
BOOST_CLASS_EXPORT_KEY(tnbLib::legLib::Aft3d_SegmentNode);

#endif // !_Aft3d_SegmentNode_Header
