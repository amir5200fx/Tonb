...
namespace tnbLib
{
	...
	void loadFiles()
	{
		...
		myBoundarySizeMaps = std::make_shared<Mesh3d_UniformBoundarySizeMapControl>(myRef, domain);
		myFeatureSizeMaps = std::make_shared<Mesh3d_UniformFeatureSizeMapControl>(myRef, domain);
