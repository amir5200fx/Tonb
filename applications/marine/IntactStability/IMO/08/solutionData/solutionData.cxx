...
namespace tnbLib
{
	...
	void execute()
	{
		...
		mySolutionData = std::make_shared<isc08Lib::SolutionData_Passenger>();
		mySolutionData->LoadModel(myModel);
		mySolutionData->SetCurrentSolution(isc08Lib::SolutionData_Passenger::solutionOrder::model);
...
int main(int argc, char *argv[])
{
	...
	if (argc IS_EQUAL 2)
	{
		...
		else if (IsEqualCommand(argv[1], "--run"))
		{
			...
			fileName myFileName("isc08SolutionData");
