...
namespace tnbLib
{
	...
	void loadModel(const std::string& name)
	{
		...
		if (NOT mySolutionData->IsUpdated(isc08Lib::SolutionData_Passenger::solutionOrder::wettedDim))
		{
			FatalErrorIn(FunctionSIG)
	...
	void execute()
	{
		...
		mySolutionData->SetCurrentSolution(isc08Lib::SolutionData_Passenger::solutionOrder::coeff);
	}
}
...
int main(int argc, char *argv[])
{
	...
	if (argc IS_EQUAL 2)
	{
		...
		else if (IsEqualCommand(argv[1], "--run"))
		{
			...
			fileName myFileName("isc08CoeffAnalys");
