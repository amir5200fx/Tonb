...
namespace tnbLib
{
	...
	void loadModel(const std::string& name)
	{
		...
		if (NOT mySolutionData->IsUpdated(isc08Lib::SolutionData_Passenger::solutionOrder::model))
		{
			FatalErrorIn(FunctionSIG)
	...
	void execute()
	{
		...
		{
			FatalErrorIn(FunctionSIG)
				<< "no model of the hull has been found!" << endl
				<< abort(FatalError);
		}
		...
		mySolutionData->SetCurrentSolution(isc08Lib::SolutionData_Passenger::solutionOrder::displacerDim);
	}
