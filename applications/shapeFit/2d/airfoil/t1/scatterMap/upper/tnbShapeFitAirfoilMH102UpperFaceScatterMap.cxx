...
namespace tnbLib
{
	...
	void execute()
	{
		myScatterMap = std::make_shared<airfoilScatterMapLib::UpperMH102>();
...
int main(int argc, char* argv[])
{
	...
	if (argc IS_EQUAL 2)
	{
		...
		{
			Info << endl;
			Info << " This application is aimed to create a MH102 scatter map for shape fitting." << endl;
			Info << endl
		...
		else if (IsEqualCommand(argv[1], "--run"))
		{
			...
			try
			{
				fileName myFileName(file::GetSystemFile("tnbShapeFitAirfoilMH102UpperFaceScatterMap"));
