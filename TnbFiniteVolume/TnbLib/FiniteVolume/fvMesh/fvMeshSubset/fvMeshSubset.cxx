...
namespace tnbLib
{
	...
	bool tnbLib::fvMeshSubset::checkCellSubset() const
	{
		if (!fvMeshSubsetPtr_)
		{
	...
	void tnbLib::fvMeshSubset::markPoints
	(
	...
	void tnbLib::fvMeshSubset::doCoupledPatches
	(
		const bool syncPar,
	...
	labelList tnbLib::fvMeshSubset::subset
	(
		const label nElems,
	...
	void tnbLib::fvMeshSubset::subsetZones()
	{
	...
	void tnbLib::fvMeshSubset::makeFvDictionaries()
	{
	...
	tnbLib::fvMeshSubset::fvMeshSubset
	(
		const IOobject& io,
	...
	void tnbLib::fvMeshSubset::setCellSubset
	(
	...
	void tnbLib::fvMeshSubset::setLargeCellSubset
	(
	...
	const fvMesh& tnbLib::fvMeshSubset::subMesh() const
	{
		checkCellSubset();
	...
	fvMesh& tnbLib::fvMeshSubset::subMesh()
	{
		checkCellSubset();
	...
	const pointMesh& tnbLib::fvMeshSubset::subPointMesh() const
	{
	...
	pointMesh& tnbLib::fvMeshSubset::subPointMesh()
	{
		if (!pointMeshSubsetPtr_)
		{
	...
	const labelList& tnbLib::fvMeshSubset::pointMap() const
	{
		checkCellSubset();
	...
	const labelList& tnbLib::fvMeshSubset::faceMap() const
	{
		checkCellSubset();
	...
	const labelList& tnbLib::fvMeshSubset::cellMap() const
	{
		checkCellSubset();
	...
	const labelList& tnbLib::fvMeshSubset::patchMap() const
	{
		checkCellSubset();
