...
void tnbLib::cellToFaceStencil::merge
(
	const label global0,
	const label global1,
...
void tnbLib::cellToFaceStencil::validBoundaryFaces(boolList& isValidBFace) const
{
...
tnbLib::cellToFaceStencil::allCoupledFacesPatch() const
{
	const polyBoundaryMesh& patches = mesh().boundaryMesh();
...
void tnbLib::cellToFaceStencil::unionEqOp::operator()
(
	labelList& x,
	const labelList& y
	) const
...
void tnbLib::cellToFaceStencil::insertFaceCells
(
...
tnbLib::labelList tnbLib::cellToFaceStencil::calcFaceCells
(
	const boolList& isValidBFace,
	const labelList& faceLabels,
	labelHashSet& globals
...
void tnbLib::cellToFaceStencil::calcFaceStencil
(
...
tnbLib::cellToFaceStencil::cellToFaceStencil(const polyMesh& mesh)
	:
	mesh_(mesh),
