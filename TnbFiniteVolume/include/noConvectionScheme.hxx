#pragma once
#ifndef _noConvectionScheme_Header
#define _noConvectionScheme_Header
...
namespace tnbLib
{
	...
	namespace fv
	{
		...
		/*---------------------------------------------------------------------------*\
							   Class noConvectionScheme Declaration
		\*---------------------------------------------------------------------------*/
...
#ifdef NoRepository
#   include <noConvectionScheme.cxx>
#endif

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

#endif // !_noConvectionScheme_Header
