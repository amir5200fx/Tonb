#pragma once
#ifndef _HydDyna_XFoil_Header
#define _HydDyna_XFoil_Header
...
#include <HydDyna_XFoil_Params.hxx>
...
namespace tnbLib
{
    ...
    private:
        ...
        bool eiwset(int nc1);
        void cgauss(int nn, std::complex<double> z[IMX4 + 1][IMX4 + 1],
            std::complex<double> r[IMX4 + 1]);
        void zccalc(int mtest);
        void zcnorm(int mtest);
        void zlefind(std::complex<double>* zle, std::complex<double> zc[], double wc[], int nc,
            std::complex<double> piq[], double agte);
        void piqsum();
        void ftp();
