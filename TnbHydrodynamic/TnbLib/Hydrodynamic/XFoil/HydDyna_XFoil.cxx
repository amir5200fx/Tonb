...
bool tnbLib::XFoil::s_bCancel = false;
bool tnbLib::XFoil::s_bFullReport = false;
double tnbLib::XFoil::vaccel = 0.01;
 ...
 * ---------------------------------------------------------------*/
bool tnbLib::XFoil::aecalc(int n, double x[], double y[], double t[], int itype,
...
double tnbLib::XFoil::aint(double number) {
    if (number >= 0)
 ...
 * -------------------------------------------------------------- */
double tnbLib::XFoil::atanc(double y, double x, double thold) {
 ...
 * ----------------------------------------------------------- */
bool tnbLib::XFoil::axset(double hk1, double t1, double rt1, double a1, double hk2,
 ...
 * ------------------------------------------------------------ */
bool tnbLib::XFoil::bldif(int ityp) {
    int k, l;
...
bool tnbLib::XFoil::blmid(int ityp) {
    //----------------------------------------------------
 ...
 *  ---------------------------------------------------------- */
bool tnbLib::XFoil::blprv(double xsi, double ami, double cti, double thi, double dsi,
 ...
 *       ityp = 3 :  turbulent wake
 * ---------------------------------------------------- */
bool tnbLib::XFoil::blvar(int ityp) {
...
bool tnbLib::XFoil::cang(double x[], double y[], int n, int& imax, double& amax) {
    //-------------------------------------------------------------------
...
bool tnbLib::XFoil::cfl(double hk, double rt, double& cf, double& cf_hk, double& cf_rt,
                        double& cf_msq) {
...
bool tnbLib::XFoil::cft(double hk, double rt, double msq, double& cf, double& cf_hk,
...
bool tnbLib::XFoil::clcalc(double xref, double yref) {
 ...
 * ---------------------------------------------- */
bool tnbLib::XFoil::cpcalc(int n, double q[], double qinf, double minf, double cp[]) {
    int i;
    bool denneg;
...
void tnbLib::XFoil::writeString(std::string str, bool bFullReport) {
...
double tnbLib::XFoil::curv(double ss, double x[], double xs[], double y[], double ys[],
                           double s[], int n) {
    int ilow, i, imid;
 ...
 * --------------------------------------------------- */
double tnbLib::XFoil::d2val(double ss, double x[], double xs[], double s[], int n) {
    int i, imid, ilow;
 ...
 * ============================================================== */
bool tnbLib::XFoil::dampl(double hk, double th, double rt, double& ax, double& ax_hk,
 ...
 *	   xs array must have been calculated by spline |
 * -------------------------------------------------- */
double tnbLib::XFoil::deval(double ss, double x[], double xs[], double s[], int n) {
    int ilow, i, imid;
...
bool tnbLib::XFoil::dil(double hk, double rt, double& di, double& di_hk,
                        double& di_rt) {
    if (hk < 4.0) {
...
bool tnbLib::XFoil::dilw(double hk, double rt, double& di, double& di_hk,
                         double& di_rt) {
    //	double msq = 0.0;
...
bool tnbLib::XFoil::dslim(double& dstr, double thet, double msq, double hklim) {
 ...
 *                              mark drela  1984
 */
bool tnbLib::XFoil::Gauss(int nn, double z[][6], double r[5]) {
 ...
 *                              mark drela  1984       *
 ****************************************************** */
bool tnbLib::XFoil::Gauss(int nn, double z[IQX][IQX], double r[IQX]) {
 ...
 * ------------------------------------------------------ */
bool tnbLib::XFoil::geopar(double x[], double xp[], double y[], double yp[], double s[],
 ...
 * ------------------------------------------------------ */
void tnbLib::XFoil::getcam(double xcm[], double ycm[], int& ncm, double xtk[],
 ...
 *      and x position
 * ------------------------------------------------ */
void tnbLib::XFoil::getmax(double x[], double y[], double yp[], int n, double& xmax,
                           double& ymax) {
    double xlen, xtol;
 ...
 * ------------------------------------------------------ */
void tnbLib::XFoil::xlfind(double& sle, double x[], double xp[], double y[],
                           double yp[], double s[], int n) {
...
void tnbLib::XFoil::sortol(double tol, int& kk, double s[], double w[]) {
    //	dimension s(kk), w(kk)
    bool done;
 ...
 * -------------------------------------------------- */
void tnbLib::XFoil::sopps(double& sopp, double si, double x[], double xp[], double y[],
...
bool tnbLib::XFoil::getxyf(double x[], double xp[], double y[], double yp[], double s[],
...
bool tnbLib::XFoil::baksub(int n, double a[IQX][IQX], int indx[], double b[]) {
    double sum;
    int i, ii, ll, j;
    ii = 0;
    for (i = 1; i <= n; i++) {
...
bool tnbLib::XFoil::hct(double hk, double msq, double& hc, double& hc_hk,
                        double& hc_msq) {
 ...
 */
void tnbLib::XFoil::hipnt(double chpnt, double thpnt) {
    //      include 'xfoil.inc'
    std::stringstream ss;
...
bool tnbLib::XFoil::hkin(double h, double msq, double& hk, double& hk_h,
                         double& hk_msq) {
...
bool tnbLib::XFoil::hsl(double hk, double& hs, double& hs_hk, double& hs_rt,
                        double& hs_msq) {
...
bool tnbLib::XFoil::hst(double hk, double rt, double msq, double& hs, double& hs_hk,
...
bool tnbLib::XFoil::initXFoilGeometry(int fn, double* fx, double* fy, double* fnx,
                                      double* fny) {
    int i, k;
...
bool tnbLib::XFoil::initXFoilAnalysis(double Re, double alpha, double Mach,
 ...
 *------------------------------------- */
bool tnbLib::XFoil::inside(double x[], double y[], int n, double xf, double yf) {
    int i, ip;
...
//------------------------------------------------------ */
bool tnbLib::XFoil::lefind(double& sle, double x[], double xp[], double y[],
                           double yp[], double s[], int n) {
    int i, iter;
...
bool tnbLib::XFoil::ludcmp(int n, double a[IQX][IQX], int indx[IQX]) {
    //	bool bimaxok = false;
 ...
 * -------------------------------------------- */
bool tnbLib::XFoil::mrcl(double cls, double& m_cls, double& r_cls) {
    std::stringstream ss;
    double rrat, cla;
...
bool tnbLib::XFoil::ncalc(double x[], double y[], double s[], int n, double xn[],
                          double yn[]) {
    double sx, sy, smod;
    int i;
    if (n <= 1) return false;
 ...
 *			wake:	  n+1 < i < n+nw
 * ----------------------------------------------------------------------- */
bool tnbLib::XFoil::psilin(int iNode, double xi, double yi, double nxi, double nyi,
 ...
 *			wake:	  n+1 < i < n+nw
 *-------------------------------------------------------------------- */
bool tnbLib::XFoil::pswlin(int i, double xi, double yi, double nxi, double nyi,
    ...
    for (jo = n + 1; jo <= n + nw - 1; jo++) {
        ...
        dsp = std::sqrt((x[jq] - x[jo]) * (x[jq] - x[jo]) +
            (y[jq] - y[jo]) * (y[jq] - y[jo]));
        dsip = 1.0 / dsp;
...
bool tnbLib::XFoil::restoreblData(int icom) {
    if (icom == 1) {
        x1 = blsav[icom].xz;
        u1 = blsav[icom].uz;
...
bool tnbLib::XFoil::saveblData(int icom) {
    if (icom == 1) {
        blsav[icom].xz = x1;
        blsav[icom].uz = u1;
 ...
 * ----------------------------------------- */
bool tnbLib::XFoil::scalc(double x[], double y[], double s[], int n) {
    s[1] = 0.0;
    for (int i = 2; i <= n; i++) {
 ...
 * ----------------------------------------------- */
bool tnbLib::XFoil::segspl(double x[], double xs[], double s[], int n) {
    int nseg, iseg, iseg0;
 ...
 *     defined by identical successive s values. |
 * ----------------------------------------------- */
bool tnbLib::XFoil::segspld(double x[], double xs[], double s[], int n, double xs1,
                            double xs2) {
    int nseg, iseg, iseg0;
...
void tnbLib::XFoil::scheck(double x[], double y[], int* n, double stol, bool* lchange) {
    //-------------------------------------------------------------
...
bool tnbLib::XFoil::setexp(double s[], double ds1, double smax, int nn) {
    //........................................................
...
/**	  Calculates x(ss)
 *	   xs array must have been calculated by spline */
double tnbLib::XFoil::seval(double ss, double x[], double xs[], double s[], int n) {
    int ilow, i, imid;
    double ds, t, cx1, cx2;
...
double tnbLib::XFoil::sign(double a, double b) {
    if (b >= 0.0)
        return fabs(a);
    else
        return -fabs(a);
 ...
 */
bool tnbLib::XFoil::sinvrt(double& si, double xi, double x[], double xs[], double s[],
                           int n) {
    int iter;
 ...
 *                                                        |
 * -------------------------------------------------------*/
void tnbLib::XFoil::splina(double x[], double xs[], double s[], int n) {
    bool lend;
 ...
 *                                                        |
 * ------------------------------------------------------- */
bool tnbLib::XFoil::splind(double x[], double xs[], double s[], int n, double xs1,
                           double xs2) {
    int nmax = 600;
...
void tnbLib::XFoil::sss(double ss, double* s1, double* s2, double del, double xbf,
    ...
    stot = std::fabs(s[n] - s[1]);

    sind = std::sin(0.5 * std::fabs(del));
    ...
    rsq = r1 * r1 + r2 * r2;
    *s1 = ss - (sind * std::sqrt(rsq) + eps * stot) * ssgn;
    *s2 = ss + (sind * std::sqrt(rsq) + eps * stot) * ssgn;
    ...
    for (int iter = 1; iter <= 10; iter++) {
        ...
        *s1 = *s1 + ds1;
        *s2 = *s2 + ds2;
        if (std::fabs(ds1) + std::fabs(ds2) < eps * stot) break;  // newton loop //go to 11
    }                                                 // 10 continue
...
bool tnbLib::XFoil::tecalc() {
    ...
    //---- total TE gap area
    dste = std::sqrt(dxte * dxte + dyte * dyte);
...
bool tnbLib::XFoil::tesys(double cte, double tte, double dte) {
    //--------------------------------------------------------
...
bool tnbLib::XFoil::trisol(double a[], double b[], double c[], double d[], int kk) {
    //-----------------------------------------
 ...
 * ----------------------------------------------------- */
bool tnbLib::XFoil::xifset(int is) {
    std::stringstream ss;
...
int tnbLib::XFoil::arefine(double x[], double y[], double s[], double xs[], double ys[],
...
int tnbLib::XFoil::cadd(int ispl, double atol, double xrf1, double xrf2) {
    int nnew, nbadd;
...
bool tnbLib::XFoil::eiwset(int nc1) {
    //----------------------------------------------------
    ...
    //---- set  m = 0  numbers
    for (ic = 1; ic <= nc; ic++) eiw[ic][0] = std::complex<double>(1.0, 0.0);

    //---- set  m = 1  numbers
    for (ic = 1; ic <= nc; ic++) eiw[ic][1] = std::exp(std::complex<double>(0.0, wc[ic]));
...
void tnbLib::XFoil::scinit(int n, double x[], double xp[], double y[], double yp[],
                           double s[], double sle) {
    //----------------------------------------------------------
    ...
    //     include 'circle.inc'
    std::complex<double> dcn, zle, zte;
    int ipass, ic;
    ...
    agte = (std::atan2(xp[n], -yp[n]) - std::atan2(xp[1], -yp[1])) / PI - 1.0;

    //---- set surface angle at first point
    ag0 = std::atan2(xp[1], -yp[1]);
    ...
    for (ic = 1; ic <= (nc - 1) / 2 + 1; ic++)
        sc[ic] = tops * (1.0 - std::cos(wwt * wc[ic])) / (1.0 - std::cos(wwt * PI));

    //---- set initial bottom surface s(w)
    wwt = 1.0 - 2.0 * dsdwle / bots;
    for (ic = (nc - 1) / 2 + 2; ic <= nc; ic++)
        sc[ic] = 1.0 - bots * (1.0 - std::cos(wwt * (wc[nc] - wc[ic]))) /
        (1.0 - std::cos(wwt * PI));
    ...
    for (ipass = 1; ipass <= 30; ipass++) {
        ...
        cn[0] = std::complex<double>(0.0, std::imag(cn[0]) + qim0);
        ...
        for (int itgap = 1; itgap <= 5; itgap++) {
            ...
            dzwt = std::abs(zte - zle) / std::abs(chordz);
        ...
        double dscmax = 0.0;
        for (ic = 1; ic <= nc; ic++)
            dscmax = std::max(dscmax, std::fabs(sc[ic] - scold[ic]));
    ...
    for (ic = 1; ic <= nc; ic++) {
        scold[ic] = sc[ic];
        xcold[ic] = std::real(zc[ic]);
        ycold[ic] = std::imag(zc[ic]);
    }

    for (ic = 1; ic <= nc; ic++) {
        double sinw = 2.0 * std::sin(0.5 * wc[ic]);
        double sinwe = 0.0;
        if (sinw > 0.0) sinwe = std::pow(sinw, (1.0 - agte));

        double hwc = 0.5 * (wc[ic] - PI) * (1.0 + agte) - 0.5 * PI;
        zcoldw[ic] = sinwe * std::exp(piq[ic] + std::complex<double>(0.0, hwc));
    }

    qimold = std::imag(cn[0]);
    return;
}

void tnbLib::XFoil::ftp() {
    //----------------------------------------------------------------
...
std::complex<double> tnbLib::XFoil::conjg(std::complex<double> cplx) {
    double a = real(cplx);
    double b = imag(cplx);
    return std::complex<double>(a, -b);
}

void tnbLib::XFoil::zcnorm(int mtest) {
    //-----------------------------------------------
    ...
    std::complex<double> zcnew, zle, zte, zc_zte, zte_cn[IMX4 + 1];
    int m, ic;
    ...
    double qimoff = -std::imag(log(chordz / zte));
...
void tnbLib::XFoil::zccalc(int mtest) {
    //--------------------------------------------------------
    ...
    //--------------------------------------------------------
    //      include 'circle.inc'
    std::complex<double> dzdw1, dzdw2, dz_piq1, dz_piq2;
    ...
    double hwc = 0.5 * (wc[ic] - PI) * (1.0 + agte) - 0.5 * PI;
    dzdw1 = sinwe * std::exp(piq[ic] + std::complex<double>(0.0, hwc));

    for (ic = 2; ic <= nc; ic++) {
        sinw = 2.0 * std::sin(0.5 * wc[ic]);
        sinwe = 0.0;
        if (sinw > 0.0) sinwe = std::pow(sinw, (1.0 - agte));

        hwc = 0.5 * (wc[ic] - PI) * (1.0 + agte) - 0.5 * PI;
        dzdw2 = sinwe * std::exp(piq[ic] + std::complex<double>(0.0, hwc));
...
void tnbLib::XFoil::zlefind(std::complex<double>* zle, std::complex<double> zc[], double wc[],
                            int nc, std::complex<double> piq[], double agte) {
    std::complex<double> dzdw1, dzdw2, zte;
    int ic, ic1, ic2;
    ...
    double sinw = 2.0 * std::sin(0.5 * wc[ic1]);
    double sinwe = std::pow(sinw, (1.0 - agte));
    double hwc = 0.5 * (wc[ic1] - PI) * (1.0 + agte) - 0.5 * PI;
    dzdw1 = sinwe * std::exp(piq[ic1] + std::complex<double>(0.0, hwc));

    sinw = 2.0 * std::sin(0.5 * wc[ic2]);
    sinwe = std::pow(sinw, (1.0 - agte));
    hwc = 0.5 * (wc[ic2] - PI) * (1.0 + agte) - 0.5 * PI;
    dzdw2 = sinwe * std::exp(piq[ic2] + std::complex<double>(0.0, hwc));
    ...
    splind(xc, xcw, wc + ic1 - 1, nic, std::real(dzdw1), std::real(dzdw2));
    splind(yc, ycw, wc + ic1 - 1, nic, std::imag(dzdw1), std::imag(dzdw2));
...
void tnbLib::XFoil::mapgam(int iac, double& alg, double& clg, double& cmg) {
    //--------------------------------------------
...
void tnbLib::XFoil::qccalc(int ispec, double* alfa, double* cl, double* cm, double minf,
    ...
    double beta = std::sqrt(1.0 - minf * minf);
    ...
    for (ipass = 1; ipass <= 10; ipass++) {
        ...
        for (ic = 1; ic <= nc; ic++) {
            ...
            if (fabs(agte) <= 0.0001)
                ...
                sinwe = std::pow(sinw, agte);
            else
                sinwe = 0.0;

            qcir[ic] = 2.0 * std::cos(0.5 * wc[ic] - alfcir) * sinwe * eppp;
            qc_a[ic] = 2.0 * std::sin(0.5 * wc[ic] - alfcir) * sinwe * eppp;

            xcir[ic] = std::real(zc[ic]);
            ycir[ic] = std::imag(zc[ic]);
            scir[ic] = sc[ic];
        }
        ...
        eia = std::exp(std::complex<double>(0.0, -*alfa));
        cft = cft * eia;
        cft_a = cft_a * eia + cft * std::complex<double>(0.0, -1.0);

        //------ lift is real part of complex force vector
        double clt = std::real(cft);
        double clt_a = std::real(cft_a);
...
void tnbLib::XFoil::mapgen(int n, double x[], double y[]) {
    //-------------------------------------------------------
    ...
    dx = xcold[2] - xcold[1];
    dy = ycold[2] - ycold[1];
    qim0 = std::atan2(dx, -dy) + 0.5 * PI * (1.0 + agte);

    qimoff = qim0 - std::imag(cn[0]);
    cn[0] = cn[0] + std::complex<double>(0.0, qimoff);
    ...
    cn[0] = std::complex<double>(0.0, std::imag(cn[0]));
...
void tnbLib::XFoil::cgauss(int nn, std::complex<double> z[IMX4 + 1][IMX4 + 1],
    std::complex<double> r[IMX4 + 1]) {
    //*******************************************
    //     solves general complex linear systems.
    //*******************************************
    //      complex z(nsiz,nsiz), r(nsiz,nrhs)
    // nrhs = 1 // techwinder : one right hand side is enough !
    std::complex<double> pivot, temp, ztmp;
    int np1;
    int nx;
    int l, k, n, np;
...
double tnbLib::XFoil::qcomp(double g) {
    return g * (1.0 - tklam) / (1.0 - tklam * (g / qinf) * (g / qinf));
}

double tnbLib::XFoil::qincom(double qc, double qinf, double tklam) {
    //-------------------------------------
    //     sets incompressible speed from
    //     karman-tsien compressible speed
    //-------------------------------------

    if (tklam < 1.0e-4 || std::fabs(qc) < 1.0e-4)
...
void tnbLib::XFoil::cncalc(double qc[], bool lsymm) {
    //----------------------------------------------------------
    ...
    for (ic = 2; ic <= nc - 1; ic++) {
        cosw = 2.0 * std::cos(0.5 * wc[ic] - alfcir);
        sinw = 2.0 * std::sin(0.5 * wc[ic]);
        sinwe = std::pow(sinw, agte);
        ...
        //------- set p(w) from q(w)
        if (std::fabs(cosw) < 1.0e-4)
            //-------- use asymptotic form near stagnation point
            pfun = std::fabs(sinwe / qcw[ic]);
        else
            //-------- use actual expression
            pfun = std::fabs(cosw * sinwe / qc[ic]);
        ...
        piq[ic] = std::complex<double>(std::log(pfun), 0.0);
    }
    ...
    if (lsymm) {
        for (m = 1; m <= mc; m++) {
            cnr = 2.0 * std::real(cn[m]) - std::real(cnsav[m]);
...
void tnbLib::XFoil::splqsp(int kqsp) {
    //------------------------------------------------------
 ...
 * ---------------------------------------------- */
void tnbLib::XFoil::qspint(int kqsp, double& clq) {
    //      include 'circle.inc'
    //      dimension qspec(nc)
    //      real minf
    int i, ip;
    ...
    sa = std::sin(alqsp[kqsp]);
    ca = std::cos(alqsp[kqsp]);

    beta = std::sqrt(1.0 - minf * minf);
    bfac = 0.5 * minf * minf / (1.0 + beta);
 ...
 * --------------------------------------------*/
void tnbLib::XFoil::smooq(int kq1, int kq2, int kqsp) {
    int i;
...
void tnbLib::XFoil::HanningFilter(double cfilt, std::stringstream& ts) {
...
void tnbLib::XFoil::cnfilt(double ffilt) {
    //-------------------------------------
    ...
    for (int m = 0; m <= mc; m++) {
        ...
        cwt = 0.5 * (1.0 + std::cos(PI * freq));
        cwtx = cwt;
        if (ffilt > 0.0) cwtx = std::pow(cwt, ffilt);
        cn[m] = std::complex<double>(std::real(cn[m]) * cwtx, std::imag(cn[m]) * cwtx);
    }
}

void tnbLib::XFoil::pert_init(int kqsp) {
    double dx, dy, qimoff;
...
void tnbLib::XFoil::pert_process(int kqsp) {
    int m, ncn;
    //	double dx,dy,qimoff;
...
void tnbLib::XFoil::gamqsp(int kqsp) {
    //------------------------------------------------
...
bool tnbLib::XFoil::mixed(int kqsp) {
    //-------------------------------------------------
...
void tnbLib::XFoil::gamlin(int i, int j, double coef) {
    //-------------------------------------------------------------------
...
void tnbLib::XFoil::tcset(double cnew, double tnew) {
    //      dimension rinput(*)
    //------------------------------------------------------
...
void tnbLib::XFoil::thkcam(double tfac, double cfac) {
    //---------------------------------------------------
...
void tnbLib::XFoil::inter(double x0[], double xp0[], double y0[], double yp0[],
...
void tnbLib::XFoil::interpolate(double xf1[], double yf1[], int n1, double xf2[],
 ...
 * -------------------------------------------------- */
void tnbLib::XFoil::tgap(double gapnew, double blend) {
 ...
 * ------------------------------------------------- */
void tnbLib::XFoil::lerad(double rfac, double blend) {
    int i;
    double doc, cvmax, cv;
    //	double radius;
 ...
 * --------------------------------------------------------- */
void tnbLib::XFoil::lerscl(double* x, double* xp, double* y, double* yp, double* s,
    ...
    xte = 0.5 * (x[1] + x[n]);
    yte = 0.5 * (y[1] + y[n]);
    chord = std::sqrt((xte - xle) * (xte - xle) + (yte - yle) * (yte - yle));

    //---- set unit chord-line vector
    dxc = (xte - xle) / chord;
    dyc = (yte - yle) / chord;

    srfac = std::sqrt(std::fabs(rfac));
    ...
    for (int i = 1; i <= n; i++) {
        ...
        tfac = 1.0 - (1.0 - srfac) * std::exp(-arg);
 ...
 */
void tnbLib::XFoil::naca4(int ides, int nside) {
    ...
    for (i = 1; i <= nside; i++) {
        ...
        yt[i] = (1.4845 * std::sqrt(xx[i]) - 0.6300 * xx[i] - 1.7580 * xx[i] * xx[i] +
 ...
 */
bool tnbLib::XFoil::naca5(int ides, int nside) {
    ...
    for (i = 1; i <= nside; i++) {
        frac = (double)(i - 1) / (double)(nside - 1);
        xx[i] = 1.0 - anp * frac * std::pow((1.0 - frac), an) - std::pow((1.0 - frac), anp);
        yt[i] = (0.29690 * std::sqrt(xx[i]) - 0.12600 * xx[i] - 0.35160 * xx[i] * xx[i] +
...
void tnbLib::XFoil::fillHk(double ws[IVX][3]) {
    int nside[3];
    nside[1] = m_nSide1;
    nside[2] = m_nSide2;
...
void tnbLib::XFoil::fillRTheta(double ws[IVX][3]) {
    int nside[3];
    nside[1] = m_nSide1;
    nside[2] = m_nSide2;
    ...
    for (int is = 1; is <= 2; is++) {
        for (int ibl = 2; ibl < nside[is]; ibl++) {
            ...
            rhoe = std::pow(herat, 1.0 / gamm1);
            amue = std::sqrt(herat * herat * herat) * (1.0 + hvrat) / (herat + hvrat);
 ...
 */
void tnbLib::XFoil::createXBL(double xs[IVX][3]) {
    int i;
