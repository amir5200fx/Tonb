...
namespace tnbLib
{
	...
	template<>
	TnbMeshBase_EXPORT Standard_Boolean Mesh3d_Facet::IsRightSide(const Pnt3d& theCoord) const;

	template<>
	TnbMeshBase_EXPORT Standard_Boolean  Mesh3d_Facet::IsLeftSide(const Pnt3d& theCoord) const;
}
