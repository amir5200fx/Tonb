...
template <class Type>
tnbLib::debug::tolerancesSwitch tnbLib::FaceCellWave<Type>::geomTol_
(
	"FaceCellWaveGeomTol",
	1e-6
);
...
template <class Type>
tnbLib::debug::tolerancesSwitch tnbLib::FaceCellWave<Type>::propagationTol_
(
...
// Write to ostream
template <class Type>
tnbLib::Ostream& tnbLib::FaceCellWave<Type>::writeFaces
(
	const label nFaces,
...
// Read from istream
template <class Type>
tnbLib::Istream& tnbLib::FaceCellWave<Type>::readFaces
(
	label& nFaces,
...
template <class Type>
bool tnbLib::FaceCellWave<Type>::updateCell
(
	const label cellI,
...
template <class Type>
bool tnbLib::FaceCellWave<Type>::updateFace
(
	const label faceI,
...
template <class Type>
void tnbLib::FaceCellWave<Type>::checkCyclic(const polyPatch& patch) const
{
...
template <class Type>
bool tnbLib::FaceCellWave<Type>::hasPatchType(const word& nameOfType)
{
...
template <class Type>
void tnbLib::FaceCellWave<Type>::setFaceInfo
(
...
template <class Type>
void tnbLib::FaceCellWave<Type>::mergeFaceInfo
(
...
template <class Type>
tnbLib::label tnbLib::FaceCellWave<Type>::getChangedPatchFaces
(
	const polyPatch& patch,
...
template <class Type>
void tnbLib::FaceCellWave<Type>::leaveDomain
(
	const polyPatch& patch,
	const label nFaces,
	const labelList& faceLabels,
...
template <class Type>
void tnbLib::FaceCellWave<Type>::enterDomain
(
	const polyPatch& patch,
	const label nFaces,
	const labelList& faceLabels,
...
template <class Type>
void tnbLib::FaceCellWave<Type>::transform
(
...
template <class Type>
void tnbLib::FaceCellWave<Type>::sendPatchInfo
(
...
template <class Type>
tnbLib::label tnbLib::FaceCellWave<Type>::receivePatchInfo
(
	const label neighbour,
	labelList& faceLabels,
	List<Type>& faceInfo
...
template <class Type>
void tnbLib::FaceCellWave<Type>::offset
(
	const polyPatch&,
...
template <class Type>
void tnbLib::FaceCellWave<Type>::handleProcPatches()
{
	// Send all
...
template <class Type>
void tnbLib::FaceCellWave<Type>::handleCyclicPatches()
{
	forAll(mesh_.boundaryMesh(), patchI)
	{
		const polyPatch& patch = mesh_.boundaryMesh()[patchI];
...
template <class Type>
tnbLib::FaceCellWave<Type>::FaceCellWave
(
	const polyMesh& mesh,
...
template <class Type>
tnbLib::label tnbLib::FaceCellWave<Type>::getUnsetCells() const
{
...
template <class Type>
tnbLib::label tnbLib::FaceCellWave<Type>::getUnsetFaces() const
{
...
template <class Type>
tnbLib::label tnbLib::FaceCellWave<Type>::faceToCell()
{
...
// Propagate cell to face
template <class Type>
tnbLib::label tnbLib::FaceCellWave<Type>::cellToFace()
{
...
// Iterate
template <class Type>
tnbLib::label tnbLib::FaceCellWave<Type>::iterate(const label maxIter)
{
	if (hasCyclicPatches_)
	{
		// Transfer changed faces across cyclic halves
