...
defineTypeNameAndDebug(tnbLib::treeDataFace, 0);

tnbLib::scalar tnbLib::treeDataFace::tolSqr = sqr(1E-6);


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

tnbLib::treeBoundBox tnbLib::treeDataFace::calcBb(const label faceI) const
{
...
void tnbLib::treeDataFace::update()
{
...
tnbLib::treeDataFace::treeDataFace
(
	const bool cacheBb,
...
tnbLib::pointField tnbLib::treeDataFace::points() const
{
...
tnbLib::label tnbLib::treeDataFace::getVolumeType
(
...
bool tnbLib::treeDataFace::overlaps
(
	const label index,
...
// nearestPoint.
void tnbLib::treeDataFace::findNearest
(
...
bool tnbLib::treeDataFace::intersects
(
	const label index,
	const point& start,
	const point& end,
