...
defineTypeNameAndDebug(tnbLib::octreeDataFace, 0);

tnbLib::scalar tnbLib::octreeDataFace::tol = 1e-6;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void tnbLib::octreeDataFace::calcBb()
{
...
tnbLib::octreeDataFace::octreeDataFace
(
...
tnbLib::octreeDataFace::octreeDataFace(const polyPatch& patch)
	:
...
tnbLib::octreeDataFace::octreeDataFace(const primitiveMesh& mesh)
	:
	mesh_(mesh),
	meshFaces_(0),
	allBb_(0)
...
// Construct as copy
tnbLib::octreeDataFace::octreeDataFace(const octreeDataFace& shapes)
	:
	mesh_(shapes.mesh()),
...
tnbLib::label tnbLib::octreeDataFace::getSampleType
(
...
bool tnbLib::octreeDataFace::overlaps
(
	const label index,
...
bool tnbLib::octreeDataFace::contains(const label, const point&) const
{
	notImplemented
	(
...
bool tnbLib::octreeDataFace::intersects
(
	const label index,
	const point& start,
	const point& end,
...
bool tnbLib::octreeDataFace::findTightest
(
	const label index,
	const point& sample,
...
tnbLib::scalar tnbLib::octreeDataFace::calcSign
(
	const label index,
	const point& sample,
	point& n
...
tnbLib::scalar tnbLib::octreeDataFace::calcNearest
(
	const label index,
	const point& sample,
	point& nearest
...
void tnbLib::octreeDataFace::write(Ostream& os, const label index) const
{
