...
template <class Type>
const tnbLib::label tnbLib::treeNode<Type>::leafOffset = 100;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template <class Type>
void tnbLib::treeNode<Type>::setAsNode(const label octant)
{
...
template <class Type>
void tnbLib::treeNode<Type>::setAsLeaf(const label octant)
{
	subNodeTypes_ &= ~(0x1 << octant);
}
...
template <class Type>
void tnbLib::treeNode<Type>::setNodePtr
(
	const label octant,
...
template <class Type>
void tnbLib::treeNode<Type>::setLeafPtr
(
	const label octant,
...
template <class Type>
void tnbLib::treeNode<Type>::setVolType
(
	const label octant,
	const label type
)
...
template <class Type>
void tnbLib::treeNode<Type>::space(Ostream& os, const label n)
{
	for (label i = 0; i < n; i++)
	{
		os << ' ';
...
template <class Type>
const tnbLib::treeLeaf<Type>* tnbLib::treeNode<Type>::findLeafLineOctant
(
	const int level,
	const Type& shapes,
	const label octant,
...
template <class Type>
tnbLib::treeNode<Type>::treeNode(const treeBoundBox& bb)
	:
	treeElem<Type>(bb),
	treeNodeName(),
	mid_(bb.midpoint()),
...
template <class Type>
tnbLib::treeNode<Type>::treeNode(Istream& is)
{
	is >> *this;
}
...
template <class Type>
void tnbLib::treeNode<Type>::distribute
(
	const label level,
	octree<Type>& top,
	const Type& shapes,
...
template <class Type>
void tnbLib::treeNode<Type>::redistribute
(
	const label level,
	octree<Type>& top,
	const Type& shapes,
...
// Set type of node.
template <class Type>
tnbLib::label tnbLib::treeNode<Type>::setSubNodeType
(
	const label level,
	octree<Type>& top,
	const Type& shapes
...
// Get type of node.
template <class Type>
tnbLib::label tnbLib::treeNode<Type>::getSampleType
(
	const label level,
...
template <class Type>
tnbLib::label tnbLib::treeNode<Type>::find
(
	const Type& shapes,
	const point& sample
) const
...
template <class Type>
bool tnbLib::treeNode<Type>::findTightest
(
	const Type& shapes,
	const point& sample,
...
template <class Type>
bool tnbLib::treeNode<Type>::findNearest
(
	const Type& shapes,
	const point& sample,
	treeBoundBox& tightest,
...
template <class Type>
bool tnbLib::treeNode<Type>::findBox
(
	const Type& shapes,
...
template <class Type>
const tnbLib::treeLeaf<Type>* tnbLib::treeNode<Type>::findLeafLine
(
	const int level,
	const Type& shapes,
	point& start,
...
template <class Type>
void tnbLib::treeNode<Type>::findLeaves
(
...
template <class Type>
void tnbLib::treeNode<Type>::printNode
(
	Ostream& os,
	const label level
) const
...
template <class Type>
void tnbLib::treeNode<Type>::writeOBJ
(
	Ostream& os,
	const label level,
	label& vertNo
...
template <class Type>
tnbLib::Istream& tnbLib::operator>>(Istream& is, treeNode<Type>& oc)
{
	for (label octant = 0; octant < 8; octant++)
	{
...
template <class Type>
tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const treeNode<Type>& tn)
{
