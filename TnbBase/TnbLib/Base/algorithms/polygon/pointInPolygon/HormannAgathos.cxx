#include <HormannAgathos.hxx>

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

tnbLib::HormannAgathos::HormannAgathos
(
...
tnbLib::HormannAgathos::inOutClassification
tnbLib::HormannAgathos::evaluate(const point2D& R) const
{
...
void tnbLib::HormannAgathos::evaluateEpsilon()
{
