...
//
//
//tnbLib::string tnbLib::stringOps::expand
//(
...
//
//
//tnbLib::string& tnbLib::stringOps::inplaceExpand
//(
//	string& s,
//	const HashTable<string, word, string::hash>& mapping,
//	const char sigil
...
//
//
//tnbLib::string tnbLib::stringOps::getVariable
//(
//	const word& name,
//	const dictionary& dict,
...
//
//
//tnbLib::string tnbLib::stringOps::trimLeft(const string& s)
//{
//	if (!s.empty())
//	{
...
//
//
//tnbLib::string& tnbLib::stringOps::inplaceTrimLeft(string& s)
//{
//	if (!s.empty())
//	{
//		string::size_type beg = 0;
...
//
//
//tnbLib::string tnbLib::stringOps::trimRight(const string& s)
//{
//	if (!s.empty())
//	{
...
//
//
//tnbLib::string& tnbLib::stringOps::inplaceTrimRight(string& s)
//{
//	if (!s.empty())
//	{
//		string::size_type sz = s.size();
...
//
//
//tnbLib::string tnbLib::stringOps::trim(const string& original)
//{
//	return trimLeft(trimRight(original));
//}
//
//
//tnbLib::string& tnbLib::stringOps::inplaceTrim(string& s)
//{
//	inplaceTrimRight(s);
//	inplaceTrimLeft(s);
//
