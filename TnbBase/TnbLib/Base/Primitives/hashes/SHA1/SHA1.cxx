...
inline uint32_t tnbLib::SHA1::swapBytes(uint32_t n)
{
#ifdef __BYTE_ORDER
...
inline void
tnbLib::SHA1::set_uint32(unsigned char *cp, uint32_t v)
{
...
void tnbLib::SHA1::processBytes(const void *data, size_t len)
{
...
void
tnbLib::SHA1::processBlock(const void *data, size_t len)
{
...
void tnbLib::SHA1::calcDigest(SHA1Digest& dig) const
{
...
tnbLib::SHA1Digest tnbLib::SHA1::digest() const
{
	SHA1Digest dig;
...
// void tnbLib::SHA1::operator=(const SHA1& rhs)
// {
//     // Check for assignment to self
//     if (this == &rhs)
//     {
//         FatalErrorIn("tnbLib::SHA1::operator=(const tnbLib::SHA1&)")
