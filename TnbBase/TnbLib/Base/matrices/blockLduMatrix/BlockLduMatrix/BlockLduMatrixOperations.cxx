...
template<class Type>
void tnbLib::BlockLduMatrix<Type>::sumDiag()
{
...
template<class Type>
void tnbLib::BlockLduMatrix<Type>::negSumDiag()
{
	typedef typename TypeCoeffField::scalarTypeField scalarTypeField;
	typedef typename TypeCoeffField::linearTypeField linearTypeField;
	typedef typename TypeCoeffField::squareTypeField squareTypeField;
...
template<class Type>
void tnbLib::BlockLduMatrix<Type>::check() const
{
	typedef typename TypeCoeffField::scalarTypeField scalarTypeField;
	typedef typename TypeCoeffField::linearTypeField linearTypeField;
	typedef typename TypeCoeffField::squareTypeField squareTypeField;
	...
	if (this->symmetric())
	{
				...
				)
		{
			...
			InfoIn("void BlockLduMatrix<Type>::check() const)")
				...
				<< tnbLib::min(mag(activeDiag) / activeSumOffDiag)
				<< endl;
		}
	}
	else if (this->asymmetric())
...
template<class Type>
void tnbLib::BlockLduMatrix<Type>::relax
(
	const Field<Type>& x,
	Field<Type>& b,
	const scalar alpha
...
template<class Type>
void tnbLib::BlockLduMatrix<Type>::setValue
(
...
template<class Type>
tnbLib::tmp<tnbLib::Field<Type> > tnbLib::BlockLduMatrix<Type>::residual
(
	const Field<Type>& x
) const
{
...
template<class Type>
typename tnbLib::tmp<tnbLib::Field<Type> > tnbLib::BlockLduMatrix<Type>::residual
(
	const Field<Type>& x,
	const Field<Type>& b
) const
...
template<class Type>
void tnbLib::BlockLduMatrix<Type>::negate()
{
	if (lowerPtr_)
	{
		lowerPtr_->negate();
...
template<class Type>
void tnbLib::BlockLduMatrix<Type>::operator=(const BlockLduMatrix<Type>& A)
{
	if (this == &A)
	{
		FatalErrorIn
...
template<class Type>
void tnbLib::BlockLduMatrix<Type>::operator*=(const scalarField& sf)
{
	typedef typename TypeCoeffField::scalarTypeField scalarTypeField;
	typedef typename TypeCoeffField::linearTypeField linearTypeField;
	typedef typename TypeCoeffField::squareTypeField squareTypeField;
...
template<class Type>
void tnbLib::BlockLduMatrix<Type>::operator*=(const scalar s)
{
	if (diagPtr_)
	{
		*diagPtr_ *= s;
