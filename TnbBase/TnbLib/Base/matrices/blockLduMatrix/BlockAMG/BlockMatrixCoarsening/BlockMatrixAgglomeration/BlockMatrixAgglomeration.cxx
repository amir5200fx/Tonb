...
tnbLib::BlockMatrixAgglomeration<Type>::weightFactor_
(
	"aamgWeightFactor",
	0.65
);
...
template<class Type>
const tnbLib::debug::tolerancesSwitch
tnbLib::BlockMatrixAgglomeration<Type>::diagFactor_
(
	"aamgDiagFactor",
	1e-8
);
...
template<class Type>
void tnbLib::BlockMatrixAgglomeration<Type>::calcAgglomeration()
{
	// Algorithm:
	...
	if (matrix_.asymmetric())
	{
		...
		magOffDiag = tnbLib::max(magUpper, magLower);
	}
...
template<class Type>
void tnbLib::BlockMatrixAgglomeration<Type>::restrictDiag
(
...
void tnbLib::BlockMatrixAgglomeration<Type>::agglomerateCoeffs
(
...
template<class Type>
void tnbLib::BlockMatrixAgglomeration<Type>::restrictDiagDecoupled
(
	const CoeffField<Type>& Coeff,
	CoeffField<Type>& coarseCoeff
) const
...
template<class Type>
tnbLib::BlockMatrixAgglomeration<Type>::BlockMatrixAgglomeration
(
...
tnbLib::BlockMatrixAgglomeration<Type>::restrictMatrix() const
{
	if (!coarsen_)
	{
		FatalErrorIn
...
template<class Type>
void tnbLib::BlockMatrixAgglomeration<Type>::restrictResidual
(
...
template<class Type>
void tnbLib::BlockMatrixAgglomeration<Type>::prolongateCorrection
(
	Field<Type>& x,
