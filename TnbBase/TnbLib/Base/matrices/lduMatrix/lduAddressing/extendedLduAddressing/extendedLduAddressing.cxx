...
void tnbLib::extendedLduAddressing::clearOut() const
{
...
void tnbLib::extendedLduAddressing::markNeighbours
(
...
void tnbLib::extendedLduAddressing::calcCellCells
(
...
void tnbLib::extendedLduAddressing::calcExtendedLowerUpper() const
{
...
void tnbLib::extendedLduAddressing::calcFaceMap() const
{
	if (faceMapPtr_)
	{
...
void tnbLib::extendedLduAddressing::calcExtendedLosort() const
{
...
void tnbLib::extendedLduAddressing::calcExtendedOwnerStart() const
{
...
void tnbLib::extendedLduAddressing::calcExtendedLosortStart() const
{
...
tnbLib::extendedLduAddressing::extendedLduAddressing
(
...
const tnbLib::unallocLabelList&
tnbLib::extendedLduAddressing::extendedLowerAddr() const
{
...
const tnbLib::unallocLabelList&
tnbLib::extendedLduAddressing::extendedUpperAddr() const
{
	// Extended lower and upper are calculated together. If one of
	// these lists has been calculated, and one of them hasn't been
	// calculated, something went terribly wrong with addressing
...
const tnbLib::unallocLabelList& tnbLib::extendedLduAddressing::faceMap() const
{
	if (!faceMapPtr_)
	{
		calcFaceMap();
...
const tnbLib::unallocLabelList&
tnbLib::extendedLduAddressing::extendedLosortAddr() const
{
	if (!extendedLosortPtr_)
	{
		calcExtendedLosort();
...
const tnbLib::unallocLabelList&
tnbLib::extendedLduAddressing::extendedOwnerStartAddr() const
{
	if (!extendedOwnerStartPtr_)
	{
...
const tnbLib::unallocLabelList&
tnbLib::extendedLduAddressing::extendedLosortStartAddr() const
{
	if (!extendedLosortStartPtr_)
	{
...
tnbLib::label
tnbLib::extendedLduAddressing::extendedTriIndex
(
	const label a,
	const label b
) const
...
bool tnbLib::extendedLduAddressing::updateMesh(const mapPolyMesh& mpm) const
{
	if (debug)
	{
		InfoIn
