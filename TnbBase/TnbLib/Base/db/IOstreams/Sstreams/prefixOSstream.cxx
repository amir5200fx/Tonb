...
void tnbLib::prefixOSstream::checkWritePrefix()
{
...
tnbLib::Ostream& tnbLib::prefixOSstream::write(const token&)
{
	return *this;
}
...
tnbLib::Ostream& tnbLib::prefixOSstream::write(const label val)
{
	checkWritePrefix();
	return OSstream::write(val);
}
