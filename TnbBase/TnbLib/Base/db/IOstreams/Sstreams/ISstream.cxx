...
char tnbLib::ISstream::nextValid()
{
	char c = 0;
...
tnbLib::Istream& tnbLib::ISstream::read(token& t)
{
...
tnbLib::Istream& tnbLib::ISstream::read(char& c)
{
	c = nextValid();
	return *this;
}
...
tnbLib::Istream& tnbLib::ISstream::read(word& str)
{
...
tnbLib::Istream& tnbLib::ISstream::read(string& str)
{
	static const int maxLen = 1024;
	static const int errLen = 80; // truncate error message for readability
	static char buf[maxLen];
...
tnbLib::Istream& tnbLib::ISstream::read(label& val)
{
	is_ >> val;
	setState(is_.rdstate());
	return *this;
...
tnbLib::Istream& tnbLib::ISstream::read(floatScalar& val)
{
	is_ >> val;
	setState(is_.rdstate());
	return *this;
...
tnbLib::Istream& tnbLib::ISstream::read(doubleScalar& val)
{
	is_ >> val;
	setState(is_.rdstate());
	return *this;
...
tnbLib::Istream& tnbLib::ISstream::read(longDoubleScalar& val)
{
	is_ >> val;
	setState(is_.rdstate());
	return *this;
...
// read binary block
tnbLib::Istream& tnbLib::ISstream::read(char* buf, std::streamsize count)
{
	if (format() != BINARY)
	{
...
tnbLib::Istream& tnbLib::ISstream::rewind()
{
...
std::ios_base::fmtflags tnbLib::ISstream::flags() const
{
	return is_.flags();
}


std::ios_base::fmtflags tnbLib::ISstream::flags(const ios_base::fmtflags f)
{
	return is_.flags(f);
}
