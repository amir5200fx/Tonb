...
namespace tnbLib
{
	...
	{
		tmp<Field<scalar>> tRes = reuseTmp<scalar, sphericalTensor>::New(tf); tr(tRes(), tf()); reuseTmp<scalar, sphericalTensor>::clear(tf); return tRes;
	}
	...
	{
		tmp<Field<sphericalTensor>> tRes = reuseTmp<sphericalTensor, sphericalTensor>::New(tf); sph(tRes(), tf()); reuseTmp<sphericalTensor, sphericalTensor>::clear(tf); return tRes;
	}
	...
	{
		tmp<Field<scalar>> tRes = reuseTmp<scalar, sphericalTensor>::New(tf); det(tRes(), tf()); reuseTmp<scalar, sphericalTensor>::clear(tf); return tRes;
	}
	...
	{
		tmp<Field<sphericalTensor>> tRes(new Field<sphericalTensor>(f.size())); inv(tRes(), f); return tRes;
	} 
	TEMPLATE tmp<Field<sphericalTensor>> inv(const tmp<Field<sphericalTensor>>& tf)
	{
		tmp<Field<sphericalTensor>> tRes = reuseTmp<sphericalTensor, sphericalTensor>::New(tf); inv(tRes(), tf()); reuseTmp<sphericalTensor, sphericalTensor>::clear(tf); return tRes;
	}
	...
	{
		tmp<Field<sphericalTensor>> tRes(new Field<sphericalTensor>(f1.size())); divide(tRes(), f1, f2); return tRes;
	} 
	TEMPLATE tmp<Field<sphericalTensor>> operator / ( const UList<scalar>& f1, const tmp<Field<sphericalTensor>>& tf2 )
	{
		tmp<Field<sphericalTensor>> tRes = reuseTmp<sphericalTensor, sphericalTensor>::New(tf2); divide(tRes(), f1, tf2()); reuseTmp<sphericalTensor, sphericalTensor>::clear(tf2); return tRes;
	} 
	TEMPLATE tmp<Field<sphericalTensor>> operator / ( const tmp<Field<scalar>>& tf1, const UList<sphericalTensor>& f2 )
	{
		tmp<Field<sphericalTensor>> tRes = reuseTmp<sphericalTensor, scalar>::New(tf1); divide(tRes(), tf1(), f2); reuseTmp<sphericalTensor, scalar>::clear(tf1); return tRes;
	} 
	TEMPLATE tmp<Field<sphericalTensor>> operator / ( const tmp<Field<scalar>>& tf1, const tmp<Field<sphericalTensor>>& tf2 )
	{
		tmp<Field<sphericalTensor>> tRes = reuseTmpTmp<sphericalTensor, scalar, scalar, sphericalTensor>::New(tf1, tf2); divide(tRes(), tf1(), tf2()); reuseTmpTmp<sphericalTensor, scalar, scalar, sphericalTensor>::clear(tf1, tf2); return tRes;
	}
	...
	{
		tmp<Field<sphericalTensor>> tRes(new Field<sphericalTensor>(f2.size())); divide(tRes(), s1, f2); return tRes;
	} 
	TEMPLATE tmp<Field<sphericalTensor>> operator / ( const scalar& s1, const tmp<Field<sphericalTensor>>& tf2 )
	{
		tmp<Field<sphericalTensor>> tRes = reuseTmp<sphericalTensor, sphericalTensor>::New(tf2); divide(tRes(), s1, tf2()); reuseTmp<sphericalTensor, sphericalTensor>::clear(tf2); return tRes;
	}
	...
	{
		tmp<Field<sphericalTensor>> tRes(new Field<sphericalTensor>(f1.size())); divide(tRes(), f1, s2); return tRes;
	} 
	TEMPLATE tmp<Field<sphericalTensor>> operator / ( const tmp<Field<scalar>>& tf1, const sphericalTensor& s2 )
	{
		tmp<Field<sphericalTensor>> tRes = reuseTmp<sphericalTensor, scalar>::New(tf1); divide(tRes(), tf1(), s2); reuseTmp<sphericalTensor, scalar>::clear(tf1); return tRes;
	}
