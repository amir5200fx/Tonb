...
template<class Type>
const char* const tnbLib::CoeffField<Type>::typeName("CoeffField");
...
inline void tnbLib::CoeffField<Type>::checkSize(const UList<Type2>& f) const
{
	if (f.size() != this->size())
	{
		FatalErrorIn
...
template<class Type>
typename tnbLib::CoeffField<Type>::scalarTypeField&
tnbLib::CoeffField<Type>::toScalar()
{
	if (!scalarCoeffPtr_)
	{
...
template<class Type>
typename tnbLib::CoeffField<Type>::linearTypeField&
tnbLib::CoeffField<Type>::toLinear()
{
	if (!linearCoeffPtr_)
	{
		// Debug check: demotion
...
template<class Type>
typename tnbLib::CoeffField<Type>::squareTypeField&
tnbLib::CoeffField<Type>::toSquare()
{
	if (!squareCoeffPtr_)
	{
		squareCoeffPtr_ =
...
template<class Type>
tnbLib::CoeffField<Type>::CoeffField(const label size)
	:
...
template<class Type>
tnbLib::CoeffField<Type>::CoeffField(const CoeffField<Type>& f)
	:
	refCount(),
	scalarCoeffPtr_(NULL),
	linearCoeffPtr_(NULL),
...
template<class Type>
tnbLib::CoeffField<Type>::CoeffField(Istream& is)
	:
	scalarCoeffPtr_(NULL),
	linearCoeffPtr_(NULL),
	squareCoeffPtr_(NULL),
...
template<class Type>
tnbLib::tmp<tnbLib::CoeffField<Type> > tnbLib::CoeffField<Type>::clone() const
{
...
template<class Type>
tnbLib::CoeffField<Type>::~CoeffField()
{
	this->clear();
}
...
template<class Type>
void tnbLib::CoeffField<Type>::clear()
{
	deleteDemandDrivenData(scalarCoeffPtr_);
	deleteDemandDrivenData(linearCoeffPtr_);
...
template<class Type>
inline tnbLib::label tnbLib::CoeffField<Type>::size() const
{
	return size_;
}
...
template<class Type>
void tnbLib::CoeffField<Type>::negate()
{
	if (scalarCoeffPtr_)
	{
...
template<class Type>
tnbLib::tmp<tnbLib::CoeffField<Type> > tnbLib::CoeffField<Type>::transpose() const
{
...
tnbLib::CoeffField<Type>::activeType() const
{
	if (scalarCoeffPtr_)
	{
...
template<class Type>
void tnbLib::CoeffField<Type>::checkActive() const
{
	label nActive = 0;
	...
	if (nActive > 1)
	{
		FatalErrorIn("void tnbLib::CoeffField<Type>::checkActive() const")
...
template<class Type>
const typename tnbLib::CoeffField<Type>::scalarTypeField&
tnbLib::CoeffField<Type>::asScalar() const
{
	if (!scalarCoeffPtr_)
	{
		FatalErrorIn
...
template<class Type>
const typename tnbLib::CoeffField<Type>::linearTypeField&
tnbLib::CoeffField<Type>::asLinear() const
{
	if (!linearCoeffPtr_)
	{
		FatalErrorIn
...
template<class Type>
const typename tnbLib::CoeffField<Type>::squareTypeField&
tnbLib::CoeffField<Type>::asSquare() const
{
	if (!squareCoeffPtr_)
	{
		FatalErrorIn
...
template<class Type>
typename tnbLib::CoeffField<Type>::scalarTypeField&
tnbLib::CoeffField<Type>::asScalar()
{
	if (linearCoeffPtr_ || squareCoeffPtr_)
	{
		FatalErrorIn
...
template<class Type>
typename tnbLib::CoeffField<Type>::linearTypeField&
tnbLib::CoeffField<Type>::asLinear()
{
	if (squareCoeffPtr_)
	{
		FatalErrorIn
...
template<class Type>
typename tnbLib::CoeffField<Type>::squareTypeField&
tnbLib::CoeffField<Type>::asSquare()
{
	if (!squareCoeffPtr_)
	{
...
template<class Type>
tnbLib::tmp<typename tnbLib::CoeffField<Type>::scalarTypeField>
tnbLib::CoeffField<Type>::component(const direction dir) const
{
	if (scalarCoeffPtr_)
	{
		return *scalarCoeffPtr_;
...
tnbLib::CoeffField<Type>::getCoeff(const label index) const
{
...
template<class Type>
void tnbLib::CoeffField<Type>::setCoeff
(
	const label index,
...
template<class Type>
void tnbLib::CoeffField<Type>::getSubset
(
	CoeffField<Type>& f,
	const label start,
	const label size
...
template<class Type>
void tnbLib::CoeffField<Type>::setSubset
(
...
template<class Type>
void tnbLib::CoeffField<Type>::zeroOutSubset
(
	const label start,
	const label size
)
...
template<class Type>
void tnbLib::CoeffField<Type>::addSubset
(
	const CoeffField<Type>& f,
	const labelList& addr
)
...
template<class Type>
void tnbLib::CoeffField<Type>::subtractSubset
(
	const CoeffField<Type>& f,
	const labelList& addr
)
...
template<class Type>
void tnbLib::CoeffField<Type>::operator=(const CoeffField<Type>& f)
{
	if (this == &f)
	{
...
template<class Type>
void tnbLib::CoeffField<Type>::operator=(const tmp<CoeffField<Type> >& tf)
{
	if (this == &(tf()))
	{
...
template<class Type>
tnbLib::tmp<tnbLib::CoeffField<Type> > tnbLib::CoeffField<Type>::operator-()
{
...
#define COMPUTED_BASE_ASSIGNMENT(op,defaultOp)                                \
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const CoeffField<Type>& f)           \
{                                                                             \
    if (f.size() != this->size())                                             \
    {                                                                         \
        FatalErrorIn                                                          \
    ...
    {                                                                         \
        ...
        {                                                                     \
            (*this) defaultOp f.asScalar();                                   \
                                                                              ...
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const tmp<CoeffField<Type> >& tf)    \
{                                                                             \
    operator op(tf());                                                        \
    tf.clear();                                                               \
}
...
#define COMPUTED_ARG_ASSIGNMENT(op)                                           \
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const scalarTypeField& f)            \
{                                                                             \
    checkSize(f);                                                             \
                                                                              \
    ...
    {                                                                         \
        ...
        this->toSquare() op stf;                                              \
                                                                              ...
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const tmp<scalarTypeField>& tf)      \
{                                                                             \
    operator op(tf());                                                        \
    tf.clear();                                                               \
}                                                                             \
                                                                              ...
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const linearTypeField& f)            \
{                                                                             \
    checkSize(f);                                                             \
                                                                              \
    const blockCoeffBase::activeLevel al = this->activeType();                \
    ...
    {                                                                         \
        ...
        this->toSquare() op stf;                                              \
                                                                              ...
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const tmp<linearTypeField>& tf)      \
{                                                                             \
    operator op(tf());                                                        \
    tf.clear();                                                               \
}                                                                             \
                                                                              ...
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const squareTypeField& f)            \
{                                                                             \
    checkSize(f);                                                             \
    this->toSquare() op f;                                                    \
}                                                                             \
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const tmp<squareTypeField>& tf)      \
{                                                                             \
    operator op(tf());                                                        \
    tf.clear();                                                               \
}
...
#define COMPUTED_BASE_OPERATOR(TYPE, op)                                      \
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const TYPE& t)                       \
{                                                                             \
    if (scalarCoeffPtr_)                                                      \
    {                                                                         \
    ...
    {                                                                         \
                                                                              ...
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const UList<TYPE>& tf)               \
{                                                                             \
    checkSize(tf);                                                            \
                                                                              \
    if (scalarCoeffPtr_)                                                      \
    ...
    {                                                                         \
                                                                              ...
                                                                              \
template<class Type>                                                          \
void tnbLib::CoeffField<Type>::operator op(const tmp<Field<TYPE> >& tf)         \
{                                                                             \
    operator op(tf());                                                        \
    tf.clear();                                                               \
}
...
// Remaining operator=
template <class Type>
void tnbLib::CoeffField<Type>::operator =(const scalarTypeField& f)
{
	checkSize(f);
	const blockCoeffBase::activeLevel al = this->activeType();
...
template <class Type>
void tnbLib::CoeffField<Type>::operator =(const tmp<scalarTypeField>& tf)
{
	operator =(tf());
	tf.clear();
}
...
template <class Type>
void tnbLib::CoeffField<Type>::operator =(const linearTypeField& f)
{
	checkSize(f);
	const blockCoeffBase::activeLevel al = this->activeType();
...
template <class Type>
void tnbLib::CoeffField<Type>::operator =(const tmp<linearTypeField>& tf)
{
	operator =(tf());
	tf.clear();
}
...
template <class Type>
void tnbLib::CoeffField<Type>::operator =(const squareTypeField& f)
{
	checkSize(f);
	this->toSquare() = f;
}
...
template <class Type>
void tnbLib::CoeffField<Type>::operator =(const tmp<squareTypeField>& tf)
{
	operator =(tf());
	tf.clear();
}
...
void tnbLib::CoeffField<Type>::operator +=(const CoeffField<Type>& f)
{
	if (f.size() != this->size())
	{
		FatalErrorIn ( "void CoeffField<tensor>::operator " "op(const CoeffField<tensor>& f)" ) << "Incorrect field size: " <<
			f.size() << " local size: " << size() << abort(FatalError);
	}
	if (this->activeType() == blockCoeffBase::SQUARE)
	{
		if (f.activeType() == blockCoeffBase::SQUARE) { this->asSquare() += f.asSquare(); }
		else if (f.activeType() == blockCoeffBase::LINEAR)
		{
			squareTypeField ff(f.size());
			expandLinear(ff, f.asLinear());
	...
	{
		if (f.activeType() == blockCoeffBase::SQUARE) { this->asSquare() += f.asSquare(); }
		if (f.activeType() == blockCoeffBase::LINEAR) { this->asLinear() += f.asLinear(); }
		else if (f.activeType() == blockCoeffBase::SCALAR)
		{
			linearTypeField ff(f.size());
			expandScalar(ff, f.asScalar());
	...
	else if (this->activeType() == blockCoeffBase::SCALAR)
	{
		if (f.activeType() == blockCoeffBase::SQUARE) { this->asSquare() += f.asSquare(); }
		if (f.activeType() == blockCoeffBase::LINEAR) { this->asLinear() += f.asLinear(); }
		else if (f.activeType() == blockCoeffBase::SCALAR) { this->asScalar() += f.asScalar(); }
	}
	else
	{
		if (f.activeType() == blockCoeffBase::SQUARE) { (*this) = f.asSquare(); }
		if (f.activeType() == blockCoeffBase::LINEAR) { (*this) = f.asLinear(); }
		else if (f.activeType() == blockCoeffBase::SCALAR) { (*this) = f.asScalar(); }
	}
}
...
template <class Type>
void tnbLib::CoeffField<Type>::operator *=(const scalar& t)
{
	if (scalarCoeffPtr_) { *(scalarCoeffPtr_) *= t; }
	else if (linearCoeffPtr_) { *(linearCoeffPtr_) *= t; }
	else if (squareCoeffPtr_) { *(squareCoeffPtr_) *= t; }
	else
	{
	}
}
...
template <class Type>
void tnbLib::CoeffField<Type>::operator *=(const UList<scalar>& tf)
{
	checkSize(tf);
	if (scalarCoeffPtr_) { *(scalarCoeffPtr_) *= tf; }
	else if (linearCoeffPtr_) { *(linearCoeffPtr_) *= tf; }
	else if (squareCoeffPtr_) { *(squareCoeffPtr_) *= tf; }
	else
	{
	}
}
...
template <class Type>
void tnbLib::CoeffField<Type>::operator *=(const tmp<Field<scalar>>& tf)
{
	operator *=(tf());
	tf.clear();
}
...
template<class Type>
tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const CoeffField<Type>& f)
{
	// Write active type
...
template<class Type>
tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const tmp<CoeffField<Type> >& tf)
{
	os << tf();
	tf.clear();
	return os;
...
#   include <CoeffFieldFunctions.cxx>
