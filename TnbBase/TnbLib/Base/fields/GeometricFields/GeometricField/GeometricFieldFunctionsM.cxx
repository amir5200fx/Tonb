...
{                                                                             \
    tnbLib::Func(res.internalField(), gf1.internalField());                     \
    tnbLib::Func(res.boundaryField(), gf1.boundaryField());                     \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
...
{                                                                             \
    tnbLib::OpFunc(res.internalField(), gf1.internalField());                   \
    tnbLib::OpFunc(res.boundaryField(), gf1.boundaryField());                   \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
...
{                                                                             \
    tnbLib::Func(res.internalField(), gf1.internalField(), gf2.internalField());\
    tnbLib::Func(res.boundaryField(), gf1.boundaryField(), gf2.boundaryField());\
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
tmp<GeometricField<ReturnType, PatchField, GeoMesh> > Func                    \
...
{                                                                             \
    tnbLib::Func(res.internalField(), dt1.value(), gf2.internalField());        \
    tnbLib::Func(res.boundaryField(), dt1.value(), gf2.boundaryField());        \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
tmp<GeometricField<ReturnType, PatchField, GeoMesh> > Func                    \
...
{                                                                             \
    tnbLib::Func(res.internalField(), gf1.internalField(), dt2.value());        \
    tnbLib::Func(res.boundaryField(), gf1.boundaryField(), dt2.value());        \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
tmp<GeometricField<ReturnType, PatchField, GeoMesh> > Func                    \
...
{                                                                             \
    tnbLib::OpFunc(res.internalField(), dt1.value(), gf2.internalField());      \
    tnbLib::OpFunc(res.boundaryField(), dt1.value(), gf2.boundaryField());      \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
tmp<GeometricField<ReturnType, PatchField, GeoMesh> > operator Op             \
...
{                                                                             \
    tnbLib::OpFunc(res.internalField(), gf1.internalField(), dt2.value());      \
    tnbLib::OpFunc(res.boundaryField(), gf1.boundaryField(), dt2.value());      \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
tmp<GeometricField<ReturnType, PatchField, GeoMesh> > operator Op             \
