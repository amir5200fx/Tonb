...
{                                                                          \
	...
	dimensionedScalar exp(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("exp" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar log(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("log" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar log10(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("log10" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar sin(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("sin" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar cos(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("cos" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar tan(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("tan" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar asin(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("asin" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar acos(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("acos" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar atan(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("atan" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar sinh(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("sinh" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar cosh(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("cosh" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar tanh(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("tanh" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar asinh(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("asinh" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar acosh(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("acosh" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar atanh(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("atanh" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar erf(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("erf" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar erfc(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("erfc" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
	...
	dimensionedScalar lgamma(const dimensionedScalar& ds)
	{
		if (!ds.dimensions().dimensionless())
		{
			FatalErrorIn("lgamma" "(const dimensionedScalar& ds)") << "ds not dimensionless" << abort(FatalError);
		}
