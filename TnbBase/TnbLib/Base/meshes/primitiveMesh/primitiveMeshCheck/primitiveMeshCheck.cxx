...
tnbLib::primitiveMesh::closedThreshold_
(
...
const tnbLib::debug::tolerancesSwitch
tnbLib::primitiveMesh::aspectThreshold_
(
...
tnbLib::primitiveMesh::nonOrthThreshold_ // deg
(
...
const tnbLib::debug::tolerancesSwitch
tnbLib::primitiveMesh::skewThreshold_
(
...
tnbLib::debug::tolerancesSwitch
tnbLib::primitiveMesh::faceAngleThreshold_
(
...
const tnbLib::debug::tolerancesSwitch
tnbLib::primitiveMesh::faceFlatnessThreshold_
(
...
bool tnbLib::primitiveMesh::checkClosedBoundary(const bool report) const
{
	if (debug)
	{
...
bool tnbLib::primitiveMesh::checkClosedCells
(
	const bool report,
	labelHashSet* setPtr,
...
) const
{
	...
	forAll(sumClosed, cellI)
	{
		...
		(
			...
			tnbLib::pow(tnbLib::max(vols[cellI], SMALL), 2.0 / 3.0)
		);
...
bool tnbLib::primitiveMesh::checkFaceAreas
(
	const bool report,
	labelHashSet* setPtr
) const
...
bool tnbLib::primitiveMesh::checkCellVolumes
(
	const bool report,
	labelHashSet* setPtr
) const
...
bool tnbLib::primitiveMesh::checkFaceOrthogonality
(
	const bool report,
	labelHashSet* setPtr
) const
...
bool tnbLib::primitiveMesh::checkFacePyramids
(
	const bool report,
...
bool tnbLib::primitiveMesh::checkFaceSkewness
(
	const bool report,
	labelHashSet* setPtr
) const
...
bool tnbLib::primitiveMesh::checkPoints
(
	const bool report,
	labelHashSet* setPtr
) const
...
bool tnbLib::primitiveMesh::checkFaceAngles
(
	const bool report,
	labelHashSet* setPtr
) const
{
	...
	const scalar maxSin =
		tnbLib::sin(faceAngleThreshold_() / 180.0*mathematicalConstant::pi);
	...
	if (nConcave > 0)
	{
		scalar maxConcaveDegr =
			tnbLib::asin(tnbLib::min(1.0, maxEdgeSin))
...
bool tnbLib::primitiveMesh::checkFaceFlatness
(
	const bool report,
	labelHashSet* setPtr
) const
...
bool tnbLib::primitiveMesh::checkEdgeAlignment
(
	const bool report,
...
bool tnbLib::primitiveMesh::checkUpperTriangular
(
	const bool report,
	labelHashSet* setPtr
) const
...
bool tnbLib::primitiveMesh::checkCellsZipUp
(
	const bool report,
	labelHashSet* setPtr
) const
...
bool tnbLib::primitiveMesh::checkFaceVertices
(
	const bool report,
	labelHashSet* setPtr
) const
...
bool tnbLib::primitiveMesh::checkDuplicateFaces
(
	const label faceI,
...
bool tnbLib::primitiveMesh::checkCommonOrder
(
	const label faceI,
	const Map<label>& nCommonPoints,
	labelHashSet* setPtr
...
bool tnbLib::primitiveMesh::checkFaceFaces
(
	const bool report,
	labelHashSet* setPtr
) const
...
bool tnbLib::primitiveMesh::checkCellDeterminant
(
...
bool tnbLib::primitiveMesh::checkTopology(const bool report) const
{
...
bool tnbLib::primitiveMesh::checkGeometry(const bool report) const
{
	label noFailedChecks = 0;
...
bool tnbLib::primitiveMesh::checkMesh(const bool report) const
{
	if (debug)
	{
