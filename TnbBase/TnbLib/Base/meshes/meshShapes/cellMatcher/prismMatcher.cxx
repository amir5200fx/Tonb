...
const tnbLib::label tnbLib::prismMatcher::vertPerCell = 6;
const tnbLib::label tnbLib::prismMatcher::facePerCell = 5;
const tnbLib::label tnbLib::prismMatcher::maxVertPerFace = 4;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

// Construct from components
tnbLib::prismMatcher::prismMatcher()
	:
	cellMatcher
	(
		vertPerCell,
...
bool tnbLib::prismMatcher::matchShape
(
...
tnbLib::label tnbLib::prismMatcher::faceHashValue() const
{
	return 2 * 3 + 4 * 4;
}


bool tnbLib::prismMatcher::faceSizeMatch
(
	const faceList& faces,
	const labelList& myFaces
) const
...
bool tnbLib::prismMatcher::isA(const primitiveMesh& mesh, const label cellI)
{
	return matchShape
	(
		true,
...
bool tnbLib::prismMatcher::isA(const faceList& faces)
{
...
bool tnbLib::prismMatcher::matches
(
