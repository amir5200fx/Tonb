...
const tnbLib::label tnbLib::wedgeMatcher::vertPerCell = 7;
const tnbLib::label tnbLib::wedgeMatcher::facePerCell = 6;
const tnbLib::label tnbLib::wedgeMatcher::maxVertPerFace = 4;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

// Construct null
tnbLib::wedgeMatcher::wedgeMatcher()
	:
	cellMatcher
	(
		vertPerCell,
...
bool tnbLib::wedgeMatcher::matchShape
(
...
tnbLib::label tnbLib::wedgeMatcher::faceHashValue() const
{
	return 2 * 3 + 4 * 4;
}


bool tnbLib::wedgeMatcher::faceSizeMatch
(
	const faceList& faces,
	const labelList& myFaces
) const
...
bool tnbLib::wedgeMatcher::isA(const primitiveMesh& mesh, const label cellI)
{
	return matchShape
	(
		true,
...
bool tnbLib::wedgeMatcher::isA(const faceList& faces)
{
...
bool tnbLib::wedgeMatcher::matches
(
