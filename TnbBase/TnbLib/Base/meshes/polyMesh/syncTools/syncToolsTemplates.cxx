...
template <class T>
void tnbLib::syncTools::separateList
(
...
template <class T, class CombineOp>
void tnbLib::syncTools::syncPointMap
(
	const polyMesh& mesh,
...
template <class T, class CombineOp>
void tnbLib::syncTools::syncEdgeMap
(
	const polyMesh& mesh,
	EdgeMap<T>& edgeValues,
	const CombineOp& cop,
...
template <class T, class CombineOp>
void tnbLib::syncTools::syncPointList
(
	const polyMesh& mesh,
	UList<T>& pointValues,
	const CombineOp& cop,
...
template <class T, class CombineOp>
void tnbLib::syncTools::syncEdgeList
(
	const polyMesh& mesh,
	UList<T>& edgeValues,
	const CombineOp& cop,
...
template <class T, class CombineOp>
void tnbLib::syncTools::syncBoundaryFaceList
(
	const polyMesh& mesh,
	UList<T>& faceValues,
	const CombineOp& cop,
...
template <class T, class CombineOp>
void tnbLib::syncTools::syncFaceList
(
	const polyMesh& mesh,
	UList<T>& faceValues,
	const CombineOp& cop,
...
template <class T>
void tnbLib::syncTools::swapBoundaryFaceList
(
	const polyMesh& mesh,
	UList<T>& faceValues,
	const bool applySeparation
...
template <class T>
void tnbLib::syncTools::swapFaceList
(
	const polyMesh& mesh,
	UList<T>& faceValues,
	const bool applySeparation
