...
bool tnbLib::regionCouplePolyPatch::active() const
{
...
void tnbLib::regionCouplePolyPatch::calcZoneAddressing() const
{
...
void tnbLib::regionCouplePolyPatch::calcRemoteZoneAddressing() const
{
	// Calculate patch-to-zone addressing
...
void tnbLib::regionCouplePolyPatch::calcPatchToPatch() const
{
...
void tnbLib::regionCouplePolyPatch::calcReconFaceCellCentres() const
{
...
void tnbLib::regionCouplePolyPatch::calcLocalParallel() const
{
	// Calculate patch-to-zone addressing
...
void tnbLib::regionCouplePolyPatch::calcSendReceive() const
{
...
const tnbLib::labelListList& tnbLib::regionCouplePolyPatch::receiveAddr() const
{
	if (!receiveAddrPtr_)
	{
		calcSendReceive();
...
const tnbLib::labelListList& tnbLib::regionCouplePolyPatch::sendAddr() const
{
	if (!sendAddrPtr_)
	{
		calcSendReceive();
...
tnbLib::regionCouplePolyPatch& tnbLib::regionCouplePolyPatch::shadow()
{
...
void tnbLib::regionCouplePolyPatch::clearDeltas() const
{
	deleteDemandDrivenData(reconFaceCellCentresPtr_);
}


void tnbLib::regionCouplePolyPatch::clearGeom() const
{
	clearDeltas();
...
void tnbLib::regionCouplePolyPatch::clearOut() const
{
	clearGeom();
...
tnbLib::regionCouplePolyPatch::regionCouplePolyPatch
(
	const word& name,
	const label size,
	const label start,
...
bool tnbLib::regionCouplePolyPatch::coupled() const
{
	return attached_;
}


const tnbLib::polyMesh& tnbLib::regionCouplePolyPatch::shadowRegion() const
{
	if (shadowRegionName_ != tnbLib::word::null)
	{
...
tnbLib::label tnbLib::regionCouplePolyPatch::shadowIndex() const
{
	if
		(
			shadowIndex_ == -1
			&& shadowRegionName_ != tnbLib::word::null
			&& shadowPatchName_ != tnbLib::word::null
			)
	{
...
tnbLib::label tnbLib::regionCouplePolyPatch::zoneIndex() const
{
...
const tnbLib::regionCouplePolyPatch& tnbLib::regionCouplePolyPatch::shadow() const
{
...
const tnbLib::faceZone& tnbLib::regionCouplePolyPatch::zone() const
{
	return boundaryMesh().mesh().faceZones()[zoneIndex()];
}


void tnbLib::regionCouplePolyPatch::attach() const
{
	if (!attached_)
	{
		attached_ = true;
...
void tnbLib::regionCouplePolyPatch::detach() const
{
	if (attached_)
	{
		attached_ = false;
...
const tnbLib::labelList& tnbLib::regionCouplePolyPatch::zoneAddressing() const
{
	if (!zoneAddressingPtr_)
	{
		calcZoneAddressing();
...
tnbLib::regionCouplePolyPatch::remoteZoneAddressing() const
{
	if (!remoteZoneAddressingPtr_)
	{
...
bool tnbLib::regionCouplePolyPatch::localParallel() const
{
	// Calculate patch-to-zone addressing
	if (!localParallelPtr_)
	{
...
const tnbLib::ggiZoneInterpolation&
tnbLib::regionCouplePolyPatch::patchToPatch() const
{
	if (master())
	{
		if (!patchToPatchPtr_)
...
tnbLib::regionCouplePolyPatch::reconFaceCellCentres() const
{
	if (!attached_)
	{
		FatalErrorIn
...
void tnbLib::regionCouplePolyPatch::initAddressing()
{
	if (active())
	{
...
void tnbLib::regionCouplePolyPatch::calcAddressing()
{
	polyPatch::calcAddressing();
}


void tnbLib::regionCouplePolyPatch::initGeometry()
{
...
void tnbLib::regionCouplePolyPatch::calcGeometry()
{
...
void tnbLib::regionCouplePolyPatch::initMovePoints(const pointField& p)
{
	clearGeom();
...
void tnbLib::regionCouplePolyPatch::movePoints(const pointField& p)
{
	polyPatch::movePoints(p);
}


void tnbLib::regionCouplePolyPatch::initUpdateMesh()
{
	polyPatch::initUpdateMesh();
}


void tnbLib::regionCouplePolyPatch::updateMesh()
{
...
void tnbLib::regionCouplePolyPatch::calcTransforms() const
{
...
void tnbLib::regionCouplePolyPatch::initOrder(const primitivePatch&) const
{}


bool tnbLib::regionCouplePolyPatch::order
(
...
void tnbLib::regionCouplePolyPatch::syncOrder() const
{}


// Write
void tnbLib::regionCouplePolyPatch::write(Ostream& os) const
{
	polyPatch::write(os);
