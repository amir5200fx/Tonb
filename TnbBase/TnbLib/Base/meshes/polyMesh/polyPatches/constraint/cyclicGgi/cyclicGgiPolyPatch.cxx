...
void tnbLib::cyclicGgiPolyPatch::checkDefinition() const
{
...
tnbLib::cyclicGgiPolyPatch::cyclicGgiPolyPatch
(
	const word& name,
	const label size,
	const label start,
...
const tnbLib::cyclicGgiPolyPatch& tnbLib::cyclicGgiPolyPatch::cyclicShadow() const
{
	return refCast<const cyclicGgiPolyPatch>(boundaryMesh()[shadowIndex()]);
}


void tnbLib::cyclicGgiPolyPatch::calcTransforms() const
{
	if (active() && debug)
	{
...
// Write
void tnbLib::cyclicGgiPolyPatch::write(Ostream& os) const
{
