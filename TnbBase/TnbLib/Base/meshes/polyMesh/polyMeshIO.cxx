...
void tnbLib::polyMesh::setInstance(const fileName& inst)
{
	if (debug)
	{
...
void tnbLib::polyMesh::setMotionWriteOpt(IOobject::writeOption wOpt)
{
	if (debug)
	{
...
void tnbLib::polyMesh::setTopoWriteOpt(IOobject::writeOption wOpt)
{
	if (debug)
	{
...
tnbLib::polyMesh::readUpdateState tnbLib::polyMesh::readUpdate()
{
	if (debug)
	{
