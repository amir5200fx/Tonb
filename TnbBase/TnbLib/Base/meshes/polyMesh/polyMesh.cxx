...
defineTypeNameAndDebug(tnbLib::polyMesh, 0);


tnbLib::word tnbLib::polyMesh::defaultRegion = "region0";
tnbLib::word tnbLib::polyMesh::meshSubDir = "polyMesh";
...
const tnbLib::pointField& tnbLib::polyMesh::allPoints() const
{
...
const tnbLib::faceList& tnbLib::polyMesh::allFaces() const
{
	if (clearedPrimitives_)
	{
...
const tnbLib::pointField& tnbLib::polyMesh::oldAllPoints() const
{
	if (!oldAllPointsPtr_)
	{
		if (debug)
...
// Reset motion by deleting old points
void tnbLib::polyMesh::setOldPoints
(
