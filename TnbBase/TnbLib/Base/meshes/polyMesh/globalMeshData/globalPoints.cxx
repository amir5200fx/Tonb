...
defineTypeNameAndDebug(tnbLib::globalPoints, 0);
...
// of shared points
tnbLib::label tnbLib::globalPoints::countPatchPoints
(
...
void tnbLib::globalPoints::addToSend
(
...
bool tnbLib::globalPoints::mergeInfo
(
...
bool tnbLib::globalPoints::storeInfo
(
	const procPointList& nbrInfo,
...
void tnbLib::globalPoints::initOwnPoints
(
...
void tnbLib::globalPoints::sendPatchPoints(const labelHashSet& changedPoints)
const
{
	const polyBoundaryMesh& patches = mesh_.boundaryMesh();
...
void tnbLib::globalPoints::receivePatchPoints(labelHashSet& changedPoints)
{
	const polyBoundaryMesh& patches = mesh_.boundaryMesh();
...
void tnbLib::globalPoints::remove(const Map<label>& directNeighbours)
{
	// Save old ones.
...
tnbLib::labelList tnbLib::globalPoints::getMasterPoints() const
{
...
void tnbLib::globalPoints::sendSharedPoints(const labelList& changedIndices) const
{
	const polyBoundaryMesh& patches = mesh_.boundaryMesh();
...
void tnbLib::globalPoints::receiveSharedPoints(labelList& changedIndices)
{
...
tnbLib::edgeList tnbLib::globalPoints::coupledPoints(const cyclicPolyPatch& pp)
{
...
tnbLib::globalPoints::globalPoints(const polyMesh& mesh)
	:
	mesh_(mesh),
