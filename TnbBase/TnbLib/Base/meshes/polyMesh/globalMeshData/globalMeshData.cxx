...
void tnbLib::globalMeshData::initProcAddr()
{
...
void tnbLib::globalMeshData::countSharedEdges
(
...
void tnbLib::globalMeshData::calcSharedEdges() const
{
					...
					)
			{
				...
				if (debug)
				{
					Pout << "globalMeshData::calcSharedEdges : "
						...
						<< tnbLib::name(slave) << " : " << procSharedEdges.size()
						<< endl;
				}
...
// Itanium.
tnbLib::label tnbLib::globalMeshData::countCoincidentFaces
(
	const scalar tolDim,
...
tnbLib::globalMeshData::globalMeshData(const polyMesh& mesh)
	:
...
tnbLib::globalMeshData::globalMeshData(const IOobject& io, const polyMesh& mesh)
	:
	processorTopology(mesh.boundaryMesh()),
	mesh_(mesh),
	bb_(mesh.points()),
...
tnbLib::globalMeshData::~globalMeshData()
{
	clearOut();
}


void tnbLib::globalMeshData::clearOut()
{
...
const tnbLib::labelList& tnbLib::globalMeshData::sharedPointGlobalLabels() const
{
...
tnbLib::pointField tnbLib::globalMeshData::sharedPoints() const
{
...
// Collect coordinates of shared points. (does parallel communication!)
tnbLib::pointField tnbLib::globalMeshData::geometricSharedPoints() const
{
...
tnbLib::label tnbLib::globalMeshData::nGlobalEdges() const
{
	if (nGlobalEdges_ == -1)
	{
		calcSharedEdges();
...
const tnbLib::labelList& tnbLib::globalMeshData::sharedEdgeLabels() const
{
...
const tnbLib::labelList& tnbLib::globalMeshData::sharedEdgeAddr() const
{
...
void tnbLib::globalMeshData::movePoints(const pointField& newPoints)
{
...
void tnbLib::globalMeshData::updateMesh()
{
	// Clear out old data
	clearOut();
...
// Write data
bool tnbLib::globalMeshData::write() const
{
	IOdictionary dict
	(
		IOobject
...
tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const globalMeshData& p)
{
