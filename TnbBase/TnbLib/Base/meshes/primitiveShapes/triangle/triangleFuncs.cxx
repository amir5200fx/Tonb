...
void tnbLib::triangleFuncs::setIntersection
(
...
void tnbLib::triangleFuncs::selectPt
(
	const bool select0,
	const point& p0,
	const point& p1,
...
bool tnbLib::triangleFuncs::intersectAxesBundle
(
	const point& V0,
	const point& V10,
	const point& V20,
...
)
{
	...
	//          V20:(0 0 -1.678573)
	//          i0:0
	if (localScale < VSMALL || tnbLib::mag(det) / localScale < SMALL)
	{
...
bool tnbLib::triangleFuncs::intersectBb
(
	const point& p0,
	const point& p1,
	const point& p2,
...
//// any of the faces of bb intersect triangle.
//// Note: so returns false if triangle inside bb.
//bool tnbLib::triangleFuncs::intersectBbExact
//(
//    const point& p0,
//    const point& p1,
//    const point& p2,
...
bool tnbLib::triangleFuncs::intersect
(
	const point& va0,
	const point& va10,
	const point& va20,
...
)
{
	...
	scalar tol = SMALL * tnbLib::sqrt(magArea);
