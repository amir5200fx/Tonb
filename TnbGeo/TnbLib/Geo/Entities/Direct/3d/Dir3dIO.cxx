...
namespace tnbLib
{
	...
	TnbGeo_EXPORT std::ostream & tnbLib::operator<<(std::ostream & os, const Dir3d & d)
	{
		os << d.X() << ",  " << d.Y() << ",  " << d.Z();
		return os;
	}

	TnbGeo_EXPORT std::istream & tnbLib::operator>>(std::istream & is, Dir3d & d)
	{
		Standard_Real x, y, z;
		std::string comma;
	...
	TnbGeo_EXPORT Ostream & tnbLib::operator<<(Ostream & os, const Dir3d & d)
	{
		os << token::BEGIN_LIST;
		os
			<< d.X()
	...
	TnbGeo_EXPORT Istream & tnbLib::operator>>(Istream & is, Dir3d & d)
	{
		Standard_Real x, y, z;
		string comma;
