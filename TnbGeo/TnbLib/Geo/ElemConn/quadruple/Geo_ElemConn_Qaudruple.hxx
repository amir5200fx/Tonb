#pragma once
#ifndef _Geo_ElemConn_Qaudruple_Header
#define _Geo_ElemConn_Qaudruple_Header
...
namespace tnbLib
{
	...
	public:
		...
		Geo_ElemConn_Qaudruple(const std::array<Standard_Integer, nbNodes>& theIndices)
			: theIndices_(theIndices)
		{}

		Geo_ElemConn_Qaudruple(std::array<Standard_Integer, nbNodes>&& theIndices)
...
BOOST_CLASS_EXPORT_KEY(tnbLib::Geo_ElemConn_Qaudruple);

#endif // !_Geo_ElemConn_Qaudruple_Header
