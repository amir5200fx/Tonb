#pragma once
#ifndef _Geo_ElemGeom_Quadrilateral_Header
#define _Geo_ElemGeom_Quadrilateral_Header
...
namespace tnbLib
{
	...
	class Geo_ElemGeom_Quadrilateral
		: public Geo_ElemGeom
	{
	...
	public:
		...
		Geo_ElemGeom_Quadrilateral(const std::array<Standard_Integer, nbNodes>& theIndices)
			: theIndices_(theIndices)
		{}

		Geo_ElemGeom_Quadrilateral(std::array<Standard_Integer, nbNodes>&& theIndices)
...
BOOST_CLASS_EXPORT_KEY(tnbLib::Geo_ElemGeom_Quadrilateral);

#endif // !_Geo_ElemGeom_Quadrilateral_Header
