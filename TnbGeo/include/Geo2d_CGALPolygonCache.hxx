#pragma once
#ifndef _Geo2d_CGALPolygonCache_Header
#define _Geo2d_CGALPolygonCache_Header
...
namespace tnbLib
{
	...
	public:
		...
		TnbGeo_EXPORT Geo2d_CGALPolygonCache(const Entity2d_Polygon&);
...
#endif // !_Geo2d_CGALPolygonCache_Header
