...
const std::string tnbLib::Server_NumObj_NewtonNonLinSolver_Info::Params::tol = "num_newton_solver_tol";
const std::string tnbLib::Server_NumObj_NewtonNonLinSolver_Info::Params::small = "num_newton_solver_delta";
const std::string tnbLib::Server_NumObj_NewtonNonLinSolver_Info::Params::zero = "num_newton_solver_zero";
const std::string tnbLib::Server_NumObj_NewtonNonLinSolver_Info::Params::under_relax = "num_newton_ur_relax";
const std::string tnbLib::Server_NumObj_NewtonNonLinSolver_Info::Params::max_nb_iters = "num_newton_solver_max_nb_iters";
