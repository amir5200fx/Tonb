...
Standard_Real tnbLib::profileLib::CamberProfile_t1::DEFAULT_CHORDLEN = 1.0;

Standard_Real tnbLib::profileLib::CamberProfile_t1::DEFAULT_MAX = 0;
Standard_Real tnbLib::profileLib::CamberProfile_t1::DEFAULT_MAX_LOC = 0.4;

Standard_Real tnbLib::profileLib::CamberProfile_t1::DEFAULT_LEAD_STEEP = 0.5;
Standard_Real tnbLib::profileLib::CamberProfile_t1::DEFAULT_LEAD_STEEP_TIGHT = 0.001;
Standard_Real tnbLib::profileLib::CamberProfile_t1::DEFAULT_LEAD_STEEP_WEIGHT = 1.0;

Standard_Real tnbLib::profileLib::CamberProfile_t1::DEFAULT_TRAIL_STEEP = 0.5;
Standard_Real tnbLib::profileLib::CamberProfile_t1::DEFAULT_TRAIL_STEEP_TIGHT = 0.001;
Standard_Real tnbLib::profileLib::CamberProfile_t1::DEFAULT_TRAIL_STEEP_WEIGHT = 1.0;

std::pair<Standard_Real, tnbLib::Dir2d> 
tnbLib::profileLib::CamberProfile_t1::Value
(
...
) const
{
	...
	auto [pt, t] = c->D1(par);
	auto paired = std::make_pair(y, std::move(t));
	return std::move(paired);
}

std::vector<std::shared_ptr<tnbLib::Pln_Curve>> 
tnbLib::profileLib::CamberProfile_t1::Curves() const
{
...
tnbLib::profileLib::CamberProfile_t1::Spans() const
{
	auto spans = Airfoil_Tools::CalcSpans(Curves());
	return std::move(spans);
}

void tnbLib::profileLib::CamberProfile_t1::Perform()
{
	...
	//std::cout << LeadSteepWeight() << std::endl;
