#include <PtdModel_WingFormNo1_MaxCamberLoc.hxx>
...
namespace tnbLib
{
	word ptdModel::WingFormNo1_MaxCamberLoc::MAX_CAMBER_LOC = "MaxCamberLoc";

	word ptdModel::WingFormNo1_MaxCamberLoc::TypeName_ = "MaxCamberLoc";
}

void tnbLib::ptdModel::WingFormNo1_MaxCamberLoc::Init()
{
	theParameter_ = MAX_CAMBER_LOC;
}

Standard_Integer
tnbLib::ptdModel::WingFormNo1_MaxCamberLoc::NbParameters() const
{
	return 1;
}

tnbLib::word
tnbLib::ptdModel::WingFormNo1_MaxCamberLoc::GetTypeName() const
{
	return TypeName_;
}

tnbLib::word
tnbLib::ptdModel::WingFormNo1_MaxCamberLoc::Parameter(const Standard_Integer /*theIndex*/) const
{
	return theParameter_;
}

std::shared_ptr<tnbLib::PtdModel_Form>
tnbLib::ptdModel::WingFormNo1_MaxCamberLoc::CreateForm() const
{
...
tnbLib::ptdModel::WingFormNo1_MaxCamberLoc::CreateProfile
(
...
) const
{
	...
	Pnt2d p1(global->SpanLength()->Value(), GetParameter(Parameters::maxCamberLoc));
