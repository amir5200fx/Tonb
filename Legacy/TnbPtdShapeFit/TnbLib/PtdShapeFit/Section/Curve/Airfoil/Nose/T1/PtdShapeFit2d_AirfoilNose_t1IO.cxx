...
TNB_SAVE_IMPLEMENTATION(tnbLib::curveLib::airfoilLib::Type1)
{
...
TNB_LOAD_IMPLEMENTATION(tnbLib::curveLib::airfoilLib::Type1)
{
	ar& boost::serialization::base_object<PtdShapeFit2d_AirfoilNose>(*this);
...
BOOST_CLASS_EXPORT_IMPLEMENT(tnbLib::curveLib::airfoilLib::Type1);