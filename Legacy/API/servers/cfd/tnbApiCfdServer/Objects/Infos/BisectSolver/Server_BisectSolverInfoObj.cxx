#include "Server_BisectSolverInfoObj.hxx"
...
const std::string tnbLib::Server_BisectSolverInfoObj::Params::tol = "bisect_solver_tol";
const std::string tnbLib::Server_BisectSolverInfoObj::Params::delta = "bisect_solver_delta";
const std::string tnbLib::Server_BisectSolverInfoObj::Params::max_nb_iters = "bisect_solver_max_nb_iters";


void tnbLib::Server_BisectSolverInfoObj::Construct(const std::string& theValue)
{
	double tol = 0;
	double delta = 0;
	int max_nb_iters = 0;
