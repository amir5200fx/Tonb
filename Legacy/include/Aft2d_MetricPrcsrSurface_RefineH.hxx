#pragma once
#ifndef _Aft2d_MetricPrcsrSurface_RefineH_Header
#define _Aft2d_MetricPrcsrSurface_RefineH_Header
...
namespace tnbLib
{
	...
	struct Aft2d_MetricPrcsrSurface_RefineH_Cache
	{
		mutable Pnt2d InitCoordCache;

	protected:

		// constructor [10/17/2022 Amir]

		Aft2d_MetricPrcsrSurface_RefineH_Cache()
			: InitCoordCache(Pnt2d::null)
		{}
	};

	class Aft2d_MetricPrcsrSurface_RefineH
		: public Aft2d_MetricPrcsrSurface
		, public Aft2d_MetricPrcsrSurface_RefineH_Cache
	{

		/*Private Data*/

		std::shared_ptr<Aft2d_OptNodeSurface_Calculator> theNodeCalculator_;
	...
	public:
		...
		using Aft2d_MetricPrcsrSurface::info;

		// default constructor [10/17/2022 Amir]

		Aft2d_MetricPrcsrSurface_RefineH()
			: theCoeff_(DEFAULT_COEFF)
			, theDelta_(DEFAULT_DELTA)
		{}

		// constructors [10/17/2022 Amir]

		/*Aft2d_MetricPrcsrSurface_RefineH(const std::shared_ptr<info>& theInfo)
			: Aft2d_MetricPrcsrSurface(theInfo)
		{}

		Aft2d_MetricPrcsrSurface_RefineH
		(
			const std::shared_ptr<Geo2d_SizeFunction>& theSizeFun, 
			const std::shared_ptr<Geo2d_MetricFunction>& theMetricFun,
			const std::shared_ptr<info>& theInfo
		)
			: Aft2d_MetricPrcsrSurface(theSizeFun, theMetricFun, theInfo)
		{}
		...
		(
			...
			: Aft2d_MetricPrcsrSurface(theIndex, theName, theSizeFun, theMetricFun, theInfo)
		{}*/


		// public functions and operators [10/17/2022 Amir]
		...
		TnbMesh_EXPORT void SetMetricFun(const std::shared_ptr<Geo2d_MetricFunction>& theFun);

		void SetNodeCalculator(const std::shared_ptr<Aft2d_OptNodeSurface_Calculator>& theCalculator)
		{
...
BOOST_CLASS_EXPORT_KEY(tnbLib::Aft2d_MetricPrcsrSurface_RefineH);

#endif // !_Aft2d_MetricPrcsrSurface_RefineH_Header
