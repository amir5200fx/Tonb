#pragma once
#ifndef _GeoIO_INPElement_CPS3_Header
#define _GeoIO_INPElement_CPS3_Header
...
namespace tnbLib
{
	...
	class GeoIO_INPElement_CPS3;

	TnbGeo_EXPORT Istream& operator>>(Istream& is, GeoIO_INPElement_CPS3&);
	TnbGeo_EXPORT std::istream& operator>>(std::istream& is, GeoIO_INPElement_CPS3&);
	...
	public:
		...
		typedef std::array<Standard_Integer, nbPoints> Array;
	...
	public:
		...
		TnbGeo_EXPORT GeoIO_INPElement_CPS3(Istream& is);
		TnbGeo_EXPORT GeoIO_INPElement_CPS3(std::istream& is);
		...
		TnbGeo_EXPORT std::vector<Standard_Integer> RetrieveIndices() const override;
...
BOOST_CLASS_EXPORT_KEY(tnbLib::GeoIO_INPElement_CPS3);

#endif // !_GeoIO_INPElement_CPS3_Header
