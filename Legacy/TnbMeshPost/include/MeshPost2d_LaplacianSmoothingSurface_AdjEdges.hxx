...
namespace tnbLib
{
		...
		: public MeshPost2d_LaplacianSmoothingSurface_AvgFun
	{
		...
		{
			ar& boost::serialization::base_object<MeshPost2d_LaplacianSmoothingSurface_AvgFun>(*this);
		}
...
BOOST_CLASS_EXPORT_KEY(tnbLib::MeshPost2d_LaplacianSmoothingSurface_AdjEdges);
