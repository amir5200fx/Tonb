                 ...
                 starreal bestmeans[NUMMEANTHRESHOLDS])
{
    ...
    arraypoolinit(&vertexinfo, sizeof(vertextype), LOG2TETSPERSTACKBLOCK, 0);
    ...
    stackinit(journal, sizeof(journalentry));
...
void staticimprove(behavior *behave,
                   ...
                   char **argv)
{
	arraypoolstack tetstack;         /* stack of tets to be improved */
