...
void printtetverts(tetcomplex *mesh, tag *tet)
{
    ...
    /* get tet vertices */
    point[0] = ((vertex *) tetcomplextag2vertex(mesh, tet[0]))->coord;
    point[1] = ((vertex *) tetcomplextag2vertex(mesh, tet[1]))->coord;
    point[2] = ((vertex *) tetcomplextag2vertex(mesh, tet[2]))->coord;
    point[3] = ((vertex *) tetcomplextag2vertex(mesh, tet[3]))->coord;
