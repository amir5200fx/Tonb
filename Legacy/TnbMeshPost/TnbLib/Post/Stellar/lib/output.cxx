                            ...
                            proxipool *pool)
{
    ...
    {
        vertexptr = (vertextype *) arraypoolforcelookup(&vertexinfo, vertextag);
        thevertex = (vertex *) proxipooltag2object(pool, vertextag);
                        ...
                        char **argv)
{
  ...
  for (i=0; i<numfaces; i++)
  {
      ...
      vertexptr0 = (vertex *) proxipooltag2object(pool, face[0]);
      vertexptr1 = (vertex *) proxipooltag2object(pool, face[1]);
      vertexptr2 = (vertex *) proxipooltag2object(pool, face[2]);
