                ...
                starreal vtxvec[3])
{
    ...
    /* get tet vertices */
    vcopy(((vertex *) tetcomplextag2vertex(mesh, opttet->verts[0]))->coord, point[0]);
    vcopy(((vertex *) tetcomplextag2vertex(mesh, opttet->verts[1]))->coord, point[1]);
    vcopy(((vertex *) tetcomplextag2vertex(mesh, opttet->verts[2]))->coord, point[2]);
    vcopy(((vertex *) tetcomplextag2vertex(mesh, opttet->verts[3]))->coord, point[3]);
              ...
              tag vtx4)
{
    ...
    point = ((vertex *) tetcomplextag2vertex(mesh, vtx))->coord;
                         ...
                         starreal vtxvec[3])
{
    ...
    v = ((vertex *) tetcomplextag2vertex(mesh, vtx))->coord;
    vcopy(v, origvertex);
    ...
    while ((*alpha > MINSTEPSIZE) && (numiter < MAXLINEITER))
    {
        ...
        if (improvebehave.usequadrics && hasquadric(vtx) && ((vertextype *) arraypoolforcelookup(&vertexinfo, vtx))->kind == FIXEDVERTEX)
               ...
               int smoothkinds)
{
    ...
    vinfo = (vertextype *) arraypoolforcelookup(&vertexinfo, vtx);
                           ...
                           int kinds)
{
    ...
    opttet incidenttets[MAXINCIDENTTETS];
                ...
                bool quiet)
{
    ...
    int nonexist = 0;
	vertextype *smoothedvert;
	arraypool smoothedverts; /* list of vertices that have already been smoothed */
    ...
    *minqualafter = HUGEFLOAT;
    ...
    while (tetstack->top != STACKEMPTY)
    {
        ...
        if (outstack != NULL)
        {
            ...
            outtet = (improvetet *) stackpush(influencestack);
            outtet->quality = 0.0;
        ...
        for (i = 0; i < 4; i++) 
        {
            ...
            if (skip == false)
            {
                ...
                /* look up vertex type */
                smoothedvert = (vertextype *) arraypoollookup(&vertexinfo, stacktet->verts[i]);
