                   ...
                   tag vtx4)
{
    ...
    /* get tet vertices */
    vcopy(((vertex *) tetcomplextag2vertex(mesh, vtx1))->coord, point[0]);
    vcopy(((vertex *) tetcomplextag2vertex(mesh, vtx2))->coord, point[1]);
    vcopy(((vertex *) tetcomplextag2vertex(mesh, vtx3))->coord, point[2]);
    vcopy(((vertex *) tetcomplextag2vertex(mesh, vtx4))->coord, point[3]);
                 ...
                 bool getlong)
{
    ...
    for (i=0; i<3; i++)
    {
        ...
        {
            /* get tet vertices */
            vcopy(((vertex *) tetcomplextag2vertex(mesh, tet[i]))->coord, point[0]);
            vcopy(((vertex *) tetcomplextag2vertex(mesh, tet[j]))->coord, point[1]);
                  ...
                  tag vtx4)
{
    ...
    /* get tet vertices */
    point[0] = ((vertex *) tetcomplextag2vertex(mesh, vtx1))->coord;
    point[1] = ((vertex *) tetcomplextag2vertex(mesh, vtx2))->coord;
    point[2] = ((vertex *) tetcomplextag2vertex(mesh, vtx3))->coord;
    point[3] = ((vertex *) tetcomplextag2vertex(mesh, vtx4))->coord;
...
#define RATIOBINS 100
  ...
  while (tet[0] != STOP) {
    ...
    vcopy(((vertex *) tetcomplextag2vertex(plex, tet[0]))->coord, point[0]);
    vcopy(((vertex *) tetcomplextag2vertex(plex, tet[1]))->coord, point[1]);
    vcopy(((vertex *) tetcomplextag2vertex(plex, tet[2]))->coord, point[2]);
    vcopy(((vertex *) tetcomplextag2vertex(plex, tet[3]))->coord, point[3]);
                              ...
                              tag vright)
{
    ...
    vcopy(((vertex *) tetcomplextag2vertex(mesh, v1))->coord, point[0]);
    vcopy(((vertex *) tetcomplextag2vertex(mesh, v2))->coord, point[1]);
    vcopy(((vertex *) tetcomplextag2vertex(mesh, vleft))->coord, point[2]);
    vcopy(((vertex *) tetcomplextag2vertex(mesh, vright))->coord, point[3]);
...
starreal worstinputangle(tetcomplex *mesh)
{
    ...
    tag edgefaces[6][2];
    improvetet * stacktet;     /* tet we're pulling off the stack */
    int i;
                    ...
                    starreal degreesfromworst)
{
    starreal minqual, meanqual[NUMMEANTHRESHOLDS];            /* quality of the worst tet in the mesh */
    arraypoolstack tetstack;      /* stack of tets  */
    improvetet *stacktet;         /* current tet */
