...
namespace tnbLib
{
	...
	TnbGeo_EXPORT std::ostream & tnbLib::operator<<(std::ostream & os, const Vec2d & d)
	{
		os << d.X() << ",  " << d.Y();
		return os;
	}

	TnbGeo_EXPORT std::istream & tnbLib::operator>>(std::istream & is, Vec2d & d)
	{
		Standard_Real x, y;
		std::string comma;
	...
	TnbGeo_EXPORT Ostream & tnbLib::operator<<(Ostream & os, const Vec2d & d)
	{
		os << token::BEGIN_LIST;
	...
	TnbGeo_EXPORT Istream & tnbLib::operator>>(Istream & is, Vec2d & d)
	{
		Standard_Real x, y;
		string comma;
