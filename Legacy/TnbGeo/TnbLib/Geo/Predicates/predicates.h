#pragma once
#ifndef _predicates_Header
#define _predicates_Header
/*****************************************************************************/
/*                                                                           */
...
#define Two_Product_2Presplit(a, ahi, alo, b, bhi, blo, x, y) \
  ...
  y = (alo * blo) - err3
											   ...
											   /* Square_1() can be done more quickly than Two_Product().                     */
...
inline double dstore(double x)
{
	return (x);
}

inline int test_double(int verbose)
{
	double x;
	int pass = 1;
...
inline void exactinit(int verbose)
{
	REAL half;
...
inline int grow_expansion(int elen, REAL *e, REAL b, REAL *h)
...
inline int grow_expansion_zeroelim(int elen, REAL *e, REAL b, REAL *h)
/* e and h can be the same. */
{
	REAL Q, hh;
	INEXACT REAL Qnew;
...
inline int fast_expansion_sum(int elen, REAL *e, int flen, REAL *f, REAL *h)
/* h cannot be e or f. */
{
	REAL Q;
	INEXACT REAL Qnew;
...
inline int fast_expansion_sum_zeroelim(int elen, REAL *e, int flen, REAL *f, REAL *h)
/* h cannot be e or f. */
{
	REAL Q;
	INEXACT REAL Qnew;
...
inline int linear_expansion_sum(int elen, REAL *e, int flen, REAL *f, REAL *h)
/* h cannot be e or f. */
{
	REAL Q, q;
	INEXACT REAL Qnew;
...
inline int linear_expansion_sum_zeroelim(int elen, REAL *e, int flen, REAL *f,
	REAL *h)
	/* h cannot be e or f. */
{
	REAL Q, q, hh;
...
inline int scale_expansion(int elen, REAL *e, REAL b, REAL *h)
...
inline REAL orient2dfast(REAL *pa, REAL *pb, REAL *pc)
{
...
inline REAL orient2dexact(REAL *pa, REAL *pb, REAL *pc)
{
...
inline REAL orient2dslow(REAL *pa, REAL *pb, REAL *pc)
{
...
inline REAL orient2dadapt(REAL *pa, REAL *pb, REAL *pc, REAL detsum)
{
	INEXACT REAL acx, acy, bcx, bcy;
...
inline REAL orient2d(REAL *pa, REAL *pb, REAL *pc)
{
...
inline REAL orient3dfast(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
	REAL adx, bdx, cdx;
	REAL ady, bdy, cdy;
	REAL adz, bdz, cdz;
...
inline REAL orient3dexact(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
...
inline REAL orient3dslow(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
...
inline REAL incirclefast(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
...
inline REAL incircleexact(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
	INEXACT REAL axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
	INEXACT REAL bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
	REAL axby0, bxcy0, cxdy0, dxay0, axcy0, bxdy0;
...
inline REAL incircleslow(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
...
inline REAL incircleadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL permanent)
{
	INEXACT REAL adx, bdx, cdx, ady, bdy, cdy;
	REAL det, errbound;
	...
	if ((bdxtail != 0.0) || (bdytail != 0.0)
		...
		Square_1(adx, adxadx1, adxadx0);
		Square_1(ady, adyady1, adyady0);
		Two_Two_Sum(adxadx1, adxadx0, adyady1, adyady0, aa3, aa[2], aa[1], aa[0]);
		aa[3] = aa3;
	}
	if ((cdxtail != 0.0) || (cdytail != 0.0)
		|| (adxtail != 0.0) || (adytail != 0.0)) {
		Square_1(bdx, bdxbdx1, bdxbdx0);
		Square_1(bdy, bdybdy1, bdybdy0);
		Two_Two_Sum(bdxbdx1, bdxbdx0, bdybdy1, bdybdy0, bb3, bb[2], bb[1], bb[0]);
		bb[3] = bb3;
	}
	if ((adxtail != 0.0) || (adytail != 0.0)
		|| (bdxtail != 0.0) || (bdytail != 0.0)) {
		Square_1(cdx, cdxcdx1, cdxcdx0);
		Square_1(cdy, cdycdy1, cdycdy0);
...
inline REAL incircle(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
...
inline REAL inspherefast(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe)
{
...
inline REAL insphereexact(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe)
{
...
inline REAL insphereslow(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe)
{
...
inline REAL insphereadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe,
	REAL permanent)
{
	INEXACT REAL aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
	REAL det, errbound;
...
inline REAL insphere(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe)
{
	REAL aex, bex, cex, dex;
	REAL aey, bey, cey, dey;
	REAL aez, bez, cez, dez;
...
inline REAL orient4dexact(REAL* pa, REAL* pb, REAL* pc, REAL* pd, REAL* pe,
...
inline REAL orient4dadapt(REAL* pa, REAL* pb, REAL* pc, REAL* pd, REAL* pe,
	REAL aheight, REAL bheight, REAL cheight, REAL dheight,
...
inline REAL orient4d(REAL* pa, REAL* pb, REAL* pc, REAL* pd, REAL* pe,
	REAL aheight, REAL bheight, REAL cheight, REAL dheight,
	REAL eheight)
{
	REAL aex, bex, cex, dex;
