...
unsigned short tnbLib::Aft2d_gModelSurface::verbose(0);

template<>
void tnbLib::Aft2d_gModelSurface::Import
(
...
namespace tnbLib
{
	...
	(
		...
		const Aft2d_MetricPrcsrSurface& theMetric,
...
#ifdef AFT_MODEL_DEBUG
template<>
void tnbLib::Aft2d_gModelSurface::MeshingOneLevel()
{
	if (verbose)
	{
...
template<>
void tnbLib::Aft2d_gModelSurface::FindValidNode
(
...
template<>
void tnbLib::Aft2d_gModelSurface::InsertNewFrontsToLevels()
{
#ifdef AFT_MODEL_DEBUG
...
template<>
void tnbLib::Aft2d_gModelSurface::CompactNumbering
(
...
template<>
void tnbLib::Aft2d_gModelSurface::CheckSelfIntersection()
{
...
template<>
void tnbLib::Aft2d_gModelSurface::ActiveFront
(
...
template<>
void tnbLib::Aft2d_gModelSurface::CheckBoundary
(
	const std::vector<std::shared_ptr<Aft2d_EdgeSurface>>& theFronts
)
{
