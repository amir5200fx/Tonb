...
unsigned short tnbLib::Aft2d_ModelAnIso::verbose(0);

template<>
void tnbLib::Aft2d_ModelAnIso::Import
(
...
namespace tnbLib
{
	...
	(
		...
		const Aft2d_MetricPrcsrAnIso& theMetric,
...
#ifdef AFT_MODEL_DEBUG
template<>
void tnbLib::Aft2d_ModelAnIso::MeshingOneLevel()
{
	if (verbose)
	{
...
template<>
void tnbLib::Aft2d_ModelAnIso::FindValidNode
(
...
template<>
void tnbLib::Aft2d_ModelAnIso::InsertNewFrontsToLevels()
{
#ifdef AFT_MODEL_DEBUG
...
template<>
void tnbLib::Aft2d_ModelAnIso::CompactNumbering
(
...
template<>
void tnbLib::Aft2d_ModelAnIso::ActiveFront
(
...
template<>
void tnbLib::Aft2d_ModelAnIso::CheckBoundary
(
	const std::vector<std::shared_ptr<Aft2d_EdgeAnIso>>& theFronts
)
{
