...
<
	...
	std::shared_ptr<tnbLib::Aft2d_gPlnCurveSurface>
>
tnbLib::Cad_gPoleSingularCurve::Split
(
...
) const
{
	...
	auto C0 = std::make_shared<Cad_gPoleSingularCurve>(std::move(c0));
	auto C1 = std::make_shared<Cad_gPoleSingularCurve>(std::move(c1));
