...
namespace tnbLib
{
		...
		: public Aft_EntityIdentifier<Aft2d_EdgeIdentifierSurface_Traits, true>
	{
		...
		{
			ar & boost::serialization::base_object<Aft_EntityIdentifier<Aft2d_EdgeIdentifierSurface_Traits, true>>(*this);
			ar & theMetric_;
			ar  &theLength3d_;
		}
...
BOOST_CLASS_EXPORT_KEY(tnbLib::Aft2d_EdgeIdentifierSurface);
