...
defineTypeNameAndDebug(tnbLib::triSurface, 0);


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

tnbLib::fileName tnbLib::triSurface::triSurfInstance(const Time& d)
{
...
tnbLib::List<tnbLib::labelledTri> tnbLib::triSurface::convertToTri
(
...
void tnbLib::triSurface::printTriangle
(
	Ostream& os,
	const string& pre,
	const labelledTri& f,
...
tnbLib::string tnbLib::triSurface::getLineNoComment(IFstream& is)
{
	string line;
	do
	{
...
void tnbLib::triSurface::checkTriangles(const bool verbose)
{
...
void tnbLib::triSurface::checkEdges(const bool verbose)
{
...
bool tnbLib::triSurface::read(Istream& is)
{
...
tnbLib::surfacePatchList tnbLib::triSurface::calcPatches(labelList& faceMap) const
{
...
void tnbLib::triSurface::setDefaultPatches()
{
	labelList faceMap;
...
tnbLib::triSurface::triSurface(const fileName& name)
	:
	ParentType(List<Face>(), pointField()),
	patches_(),
	sortedEdgeFacesPtr_(NULL),
...
tnbLib::triSurface::triSurface(Istream& is)
	:
	ParentType(List<Face>(), pointField()),
	patches_(),
	sortedEdgeFacesPtr_(NULL),
...
tnbLib::triSurface::triSurface(const Time& d)
	:
	ParentType(List<Face>(), pointField()),
	patches_(),
	sortedEdgeFacesPtr_(NULL),
...
tnbLib::triSurface::triSurface(const triSurface& ts)
	:
...
void tnbLib::triSurface::clearTopology()
{
...
void tnbLib::triSurface::clearPatchMeshAddr()
{
	ParentType::clearPatchMeshAddr();
}


void tnbLib::triSurface::clearOut()
{
	ParentType::clearOut();
...
const tnbLib::labelListList& tnbLib::triSurface::sortedEdgeFaces() const
{
...
const tnbLib::labelList& tnbLib::triSurface::edgeOwner() const
{
	if (!edgeOwnerPtr_)
	{
		calcEdgeOwner();
...
//- Move points
void tnbLib::triSurface::movePoints(const pointField& newPoints)
{
...
// scale points
void tnbLib::triSurface::scalePoints(const scalar& scaleFactor)
{
	// avoid bad scaling
...
// Remove non-triangles, double triangles.
void tnbLib::triSurface::cleanup(const bool verbose)
{
...
void tnbLib::triSurface::markZone
(
...
tnbLib::label tnbLib::triSurface::markZones
(
	const boolList& borderEdge,
	labelList& faceZone
) const
...
void tnbLib::triSurface::subsetMeshMap
(
...
tnbLib::triSurface tnbLib::triSurface::subsetMesh
(
	const boolList& include,
	labelList& pointMap,
	labelList& faceMap
...
void tnbLib::triSurface::write(Ostream& os) const
{
	os << patches() << endl;
...
void tnbLib::triSurface::write(const Time& d) const
{
	fileName foamFile(d.caseName() + ".ftr");
...
void tnbLib::triSurface::writeStats(Ostream& os) const
{
